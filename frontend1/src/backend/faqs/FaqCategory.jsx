...
function FaqCategory() {
  ...
  let searchbar = async () => {
    let response = await axios.get(
      `http://52.9.253.67:1600/faqsearchcategory/${search}`
    );
    setUser(response.data);
  };

  let alldata = async () => {
    let response = await axios.get("http://52.9.253.67:1600/faqcategorydata");
    setUser(response.data);
  };

  let deletedata = async (id) => {
    await axios.delete(`http://52.9.253.67:1600/faqcategorydelete/${id}`, user);
            ...
            <div class="d-flex justify-content-between mb-3">
              ...
              <div className="d-flex w-100 justify-content-end">
                <div className="mt-2 mt-lg-0 ms-lg-2 ms-xl-0 ms-xxl-0">
                  <Link to="/admin/faq-categories/create">
