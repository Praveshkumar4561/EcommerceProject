...
function RobotTxt() {
  ...
  const saveRobotsTxt = async () => {
    try {
      await axios.post("https://demo.webriefly.com/api/update-robots", {
        content: code,
      });
        ...
        <div className="row d-flex justify-content-md-center ps-1">
          <div className="d-flex flex-column align-items-center mt-1 col-12 col-lg-6 ms-lg-5 ps-lg-5 w-100">
            <div className="position-relative border rounded-1 custom-code me-3">
              ...
              <CodeMirror
                className="border rounded text-start ms-4 me-3 mb-3"
                value={code}
                options={{
                  lineNumbers: true,
                  mode: "css",
              ...
              <div className="d-flex flex-column">
                <label htmlFor="" className="ms-4 ps-1 fw-medium">
            ...
            <div className="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-6 col-xxl-6 border rounded ms-0 mt-md-3 mt-md-0 published-box mt-2 me-1 mb-4">
