...
function CustomHtml() {
  ...
  const saveCustomHTML = async () => {
    ...
    try {
      ...
      toast.success("Custom HTML applied successfully", {
      ...
      toast.error("Error saving Custom HTML", {
        position: "bottom-right",
        autoClose: 1000,
        closeOnClick: true,
        draggable: true,
    ...
    const fetchData = async () => {
      try {
        ...
        if (response.data.header_html) {
          setHeaderHtml(response.data.header_html);
        }
        if (response.data.body_html) {
          setBodyHtml(response.data.body_html);
        }
        if (response.data.footer_html) {
          setFooterHtml(response.data.footer_html);
        }
      } catch (error) {
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Custom HTML | RxLYTE</title>
        ...
        <meta property="og:title" content="Custom HTML | RxLYTE" />
      ...
      >
        <div className="sidebar-html mt-1">
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb ms-2 cart-cart d-flex flex-wrap flex-lg-nowrap">
          ...
          <li className="breadcrumb-item fw-medium text-dark">CUSTOM HTML</li>
        </ol>
      </nav>

      <div className="container">
        <div className="row d-flex justify-content-md-center ps-1 cart-car">
          <div className="d-flex flex-column align-items-center mt-1 col-12 ms-lg-5 ps-lg-5 col-lg-6 w-100">
            <div className="position-relative border rounded-1 custom-code me-0">
              ...
              <p
                ...
                style={{ color: "#6c7a91" }}
              >
                HTML in header of page, no special tags: script, style,
                iframe...
              </p>

              <p className="ms-4 mt-3 text-start">Body HTML</p>
              ...
              <p className="ms-4 mt-3 text-start">Footer HTML</p>
              ...
              <p
                ...
                style={{ color: "#6c7a91" }}
              >
                HTML in footer of page, no special tags: script, style,
                iframe...
              </p>
            </div>

            <div className="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-6 col-xxl-6 border rounded ms-0 mt-md-3 mt-md-0 published-box mt-2 me-0 mb-4">
