...
function CustomJs() {
  ...
  const handleHeaderChange = (editor, data, value) => {
    setHeaderJs(value);
  };

  const handleBodyChange = (editor, data, value) => {
    setBodyJs(value);
  };

  const handleFooterChange = (editor, data, value) => {
    setFooterJs(value);
  };
  ...
  const saveCustomJS = async () => {
    ...
    try {
      await axios.post(
        "https://demo.webriefly.com/api/save-custom-code",
        customJSData
      );
      toast.success("Custom Js applied successfully", {
      ...
      toast.error("Error saving Custom JS", {
        position: "bottom-right",
        autoClose: 1000,
        closeOnClick: true,
        draggable: true,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Custom JS | RxLYTE" />
      ...
      <div
        className={`sidebar-container mt- ${
          isNavbarExpanded && isMobile ? "expanded" : ""
        }`}
      >
        <div className="sidebar-js mt-1">
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb ms-2 cart-cart d-flex flex-wrap flex-lg-nowrap">
          ...
          <li className="breadcrumb-item fw-medium text-dark">APPEARANCE</li>
          <li className="breadcrumb-item fw-medium text-dark">CUSTOM JS</li>
        </ol>
      </nav>

      <div className="container">
        <div className="row d-flex justify-content-md-center ps-1 cart-cart">
          <div className="d-flex flex-column align-items-center mt-1 col-12 col-lg-6 ms-lg-5 ps-lg-5 w-100">
            <div className="position-relative border rounded-1 custom-code me-3">
              <p className="ms-4 mt-3 text-start">Header JS</p>
              <CodeMirror
                className="border rounded text-start ms-3 me-3 mb-3"
                value={headerJs}
                options={{
                  lineNumbers: true,
                  mode: "javascript",
                ...
                onBeforeChange={handleHeaderChange}
              />
              <p
                className="ms-3 text-start text-dark"
                style={{ color: "#6c7a91" }}
              >
                JS in header of page, wrap it inside{" "}
                <code style={{ color: "#6c7a91" }} className="text-dark">
                  &lt;script&gt;&lt;/script&gt;
                </code>
              </p>

              <p className="ms-4 mt-3 text-start">Body JS</p>
              <CodeMirror
                className="border rounded text-start ms-3 me-3 mb-3"
                value={bodyJs}
                options={{
              ...
              <p
                ...
                style={{ color: "#6c7a91" }}
              >
                JS in body of page, wrap it inside{" "}
                <code style={{ color: "#6c7a91" }} className="text-dark">
                  &lt;script&gt;&lt;/script&gt;
                </code>
              </p>

              <p className="ms-4 mt-3 text-start">Footer JS</p>
              <CodeMirror
                className="border rounded text-start ms-3 me-3 mb-3"
                value={footerJs}
                options={{
                ...
                onBeforeChange={handleFooterChange}
              />
              <p
                className="ms-3 text-start text-dark"
                style={{ color: "#6c7a91" }}
              >
                JS in footer of page, wrap it inside{" "}
                <code style={{ color: "#6c7a91" }} className="text-dark">
                  &lt;script&gt;&lt;/script&gt;
                </code>
              </p>
            ...
            <div className="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-6 col-xxl-6 border rounded ms-0 mt-md-3 mt-md-0 published-box mt-2 me-4 mb-4">
              <p className="ms-4 mt-3 mb-3 text-start">Publish</p>
              <hr />
              <button
                onClick={saveCustomJS}
