...
function Typography() {
  ...
  useEffect(() => {
    axios
      .get("http://89.116.170.231:1600/get-font-settings")
  ...
  return (
    <>
      ...
      <div className="container mt-4 d-flex cart-cart">
        ...
        <div className="content d-flex flex-column justify-content-center content-theme border border-start-0 rounded-0 ms-0 mb-1 mb-lg-0">
            ...
            <div className="mb-3 mt-2 ms-3 me-3">
              <div className="mb-3">
                ...
                >
                  ...
                  <option value="Arial" data-select2-id="select2-data-18-ruoh">
                    Arial
                  </option>
