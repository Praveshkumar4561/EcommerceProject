  ...
  return (
    <>
      <Helmet>
        ...
        <title>Theme Options - Facebook Integration | RxLYTE</title>
        ...
        <meta
          property="og:title"
          content="Theme Options - Facebook Integration | RxLYTE"
        />
      ...
      <nav className="breadcrumb-container text-center theme-appearance1">
        <ol className="breadcrumb d-flex flex-wrap">
          ...
          <li className="breadcrumb-item fw-medium text-dark">
            THEME OPTIONS-FACEBOOK INTEGRATION
          </li>
        </ol>
      </nav>
            ...
            <div className="mb-3 mt-2">
              <div className="mb-3">
                ...
                <div className="facebook-integrate">
                  ...
                  <div className="mt-1">
                    <small className="text-muted">
                      To show chat box on that website, please go to{" "}
                      <Link
                        className="link-facebook facebook-admi"
                        to="https://www.facebook.com/[PAGE_ID]/settings/?tab=messenger_platform"
                        target="_blank"
                      >
                        {" "}
                        https://www.facebook.com/[PAGE_ID]/settings/?tab=messenger_platform{" "}
                      </Link>{" "}
                      and add to whitelist domains!
                    </small>
                  </div>
                </div>
                ...
                <div className="facebook-integrate">
                  ...
                  <div className="mt-1">
                    <small className="text-muted">
                      You can get fan page ID using this site{" "}
                      <Link
                        to="https://findidfb.com"
