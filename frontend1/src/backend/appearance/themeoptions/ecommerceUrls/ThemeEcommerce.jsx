  ...
  return (
    <>
      <Helmet>
        ...
        <title>Theme Options - Ecommerce URLs | RxLYTE</title>
        ...
        <meta
          property="og:title"
          content="Theme Options - Ecommerce URLs | RxLYTE"
        />
      ...
      >
        <div className="sidebar-back8 mt-1">
      ...
      <nav className="breadcrumb-container text-center theme-appearance3">
      ...
      <div className="container mt-4 d-flex cart-cart">
        ...
        <div className="content d-flex flex-column justify-content-center content-theme border border-start-0 rounded-0 ms-0">
          ...
          <form className="content-form ms-3 me-3">
            <div className="mb-3 mt-4 pt-3">
              <span className="custom-user">
                Customize the slugs used for ecommerce pages. Be cautious when
                modifying as it can affect SEO and user experience. If something
                goes wrong, you can reset to default by typing the default value
                or leave it blank.
              </span>
            ...
            <div className="mt-3">
              <label className="form-label" htmlFor="site-title">
                Customer edit account page slug
              </label>
              <input
                className="form-control py-4 label-cookie"
                id="site-title"
            ...
            <div className="mt-3">
              <label className="form-label" htmlFor="site-title">
                Customer product reviews page slug
              </label>
              <input
                className="form-control py-4 label-cookie"
                id="site-title"
