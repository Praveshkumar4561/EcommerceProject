      ...
      <div className="container mt-4 d-flex">
        ...
        <div className="content d-flex flex-column justify-content-center content-theme border rounded ms-0">
          <div className="d-flex justify-content-end mt-2 mt-lg-0">
            <button className="btn btn-success button-change1 py-4 mt-2 mt-lg-0 border d-flex">
              Save Chaneges
            </button>
          </div>
          <hr className="custom-changes2 mt-4" />
          <form className="content-form-page">
            <div className="mb-4">
              ...
              <select
                className="form-select py-4 label-hotline4"
                id="date-format"
              >
