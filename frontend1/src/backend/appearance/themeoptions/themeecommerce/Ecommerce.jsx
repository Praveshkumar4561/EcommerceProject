  ...
  return (
    <>
      <Helmet>
        ...
        <title>Theme Options - Ecommerce | RxLYTE</title>
        ...
        <meta
          property="og:title"
          content="Theme Options - Ecommerce | RxLYTE"
        />
      ...
      >
        <div className="sidebar-back7 mt-1">
      ...
      <div className="container mt-4 d-flex cart-cart">
        ...
        <div className="content d-flex flex-column justify-content-center content-theme border border-start-0 rounded-0 ms-0">
          ...
          <form className="content-form ms-3 me-3">
            <div className="mb-3 mt-2 pt-1">
              <div>
                <label className="form-label" htmlFor="date-format">
                  Enable header categories dropdown?
                </label>
                ...
                <div>
                  <label className="form-label mt-3" htmlFor="date-format">
                    Enable header categories dropdown on mobile?
                  </label>
                ...
                <div>
                  <label className="form-label mt-3" htmlFor="hotline">
                    Enable mega menu in product categories dropdown?
                  </label>
                  <select
                    className="form-select label-hotline label-date"
                    id="date-format"
                ...
                <div className="mt-3">
                  <label htmlFor="">Product listing review style</label>
                  <div className="d-flex mt-2" style={{ cursor: "pointer" }}>
                    <div
                      className={`border rounded w-auto ${
                        selectedStyle === "default" ? "active" : ""
                      }`}
                      onClick={() => handleSelectStyle("default")}
                    >
                      <input
                        type="checkbox"
                        className="review-radio form-check-input"
                        checked={selectedStyle === "default"}
                        readOnly
                      />
                      <img
                        src="https://shofy.botble.com/themes/shofy/images/product-listing-review/default.png"
                        alt="Default"
                        className="img-fluid"
                      />
                    </div>
                    ...
                    <div
                      className={`border rounded w-auto ms-1 mt-3 mt-lg-0 ${
                    ...
                    >
                      <input
                        type="checkbox"
                        className="review-radio form-check-input mb-3"
                        checked={selectedStyle === "minimal"}
                        readOnly
                      />
                      <img
                        src="https://shofy.botble.com/themes/shofy/images/product-listing-review/minimal.png"
                        alt="Minimal"
                        className="img-fluid"
                      />
                    </div>
                ...
                <div>
                  <label className="form-label mt-4" htmlFor="hotline">
            ...
            <div>
              <label htmlFor="">Product item style</label>
              <div className="d-flex flex-wrap mb-3 mt-2">
                <div className="border me-1 ecommerce-product rounded">
                  <input
                    type="radio"
                    id="style1"
                    name="productStyle"
                    className="form-style form-check-input"
                  />
                  <label htmlFor="style1">
                    <img
                      src="https://shofy.botble.com/themes/shofy/images/product-item-styles/product-item-1.png"
                      alt="Style 1"
                ...
                <div className="border me-1 ecommerce-product rounded mt-2 mt-lg-0">
                  <input
                    type="radio"
                    id="style2"
                    name="productStyle"
                  ...
                  <label htmlFor="style2">
                    <img
                      src="https://shofy.botble.com/themes/shofy/images/product-item-styles/product-item-2.png"
                      alt="Style 2"
                      className="img-fluid"
                      style={{ cursor: "pointer" }}
                    />
                ...
                <div className="border ecommerce-product rounded mt-2 mt-lg-0">
                  <input
                    type="radio"
                    id="style3"
                    name="productStyle"
                  ...
                  <label htmlFor="style3">
                    <img
                      src="https://shofy.botble.com/themes/shofy/images/product-item-styles/product-item-3.png"
                      alt="Style 3"
                      className="img-fluid"
                      style={{ cursor: "pointer" }}
                    />
                ...
                <div className="border mt-4 ecommerce-product rounded">
                  <input
                    type="radio"
                    id="style4"
                    name="productStyle"
                    className="form-style form-check-input"
                  />
                  <label htmlFor="style4">
                    <img
                      src="https://shofy.botble.com/themes/shofy/images/product-item-styles/product-item-4.png"
                      alt="Style 4"
                      className="img-fluid"
                      style={{ cursor: "pointer" }}
                    />
                ...
                <div className="border mt-4 ms-2 ecommerce-product rounded">
                  <input
                    type="radio"
                    id="style5"
                    name="productStyle"
                    className="form-style form-check-input"
                  />
                  <label htmlFor="style5">
                    <img
                      src="https://shofy.botble.com/themes/shofy/images/product-item-styles/product-item-5.png"
                      alt="Style 5"
                      className="img-fluid"
                      style={{ cursor: "pointer" }}
                    />
            ...
            <div className="mb-3">
              <label className="form-label" htmlFor="site-title">
                Number of products per row on mobile
              </label>
              <select
                className="form-select label-hotline label-date"
                style={{ height: "50px" }}
            ...
            <div className="mt-3">
              <label className="form-label" htmlFor="site-title">
                Number of cross sale products in product detail page
              </label>
              <input
                className="form-control py-4 label-cookie"
                id="site-title"
            ...
            <div className="mt-3">
              <label htmlFor="">
                Logo in the checkout page (Default is the main logo)
              </label>
              <div
            ...
            <div className="mt-3">
              ...
              >
                {loginBackgroundImageUrl ? (
                  ...
                  <img src={Login} alt="RxLYTE" className="w-75 h-75" />
                )}
              </div>
              <input
                id="fileInputLogin"
