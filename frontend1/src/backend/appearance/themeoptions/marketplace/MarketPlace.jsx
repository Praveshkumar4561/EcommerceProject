...
function MarketPlace() {
  ...
  return (
    <>
      ...
      <nav className="breadcrumb-container text-center theme-appearance2">
      ...
      <div className="container mt-4 d-flex">
        <div className="sidebar-theme-options1 border rounded">
          ...
          <nav className="nav flex-column bg-light general-theme pt-2 ps-2 ps-lg-0">
            <Link
              className="nav-link general-theme pt-2"
        ...
        <div className="content d-flex flex-column justify-content-center content-theme border border-start-0 rounded ms-0 save-changes">
          <div className="d-flex justify-content-end mt-lg-0">
            <button className="btn btn-success button-change2 py-4 border d-flex ">
              Save Chaneges
            </button>
          </div>
          <hr className="custom-change-logo" />
          <form className="logo-default">
            <div className="mb-3">
              <div>
                <label>
                  Logo in the vendor dashboard (Default is the main logo)
                </label>
                <div
