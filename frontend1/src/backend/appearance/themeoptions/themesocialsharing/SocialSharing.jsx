  ...
  return (
    <>
      <Helmet>
        ...
        <title>Theme Options - Social Sharing | RxLYTE</title>
        ...
        <meta
          property="og:title"
          content="Theme Options - Social Sharing | RxLYTE"
        />
      ...
      <nav className="breadcrumb-container text-center theme-appearance4">
