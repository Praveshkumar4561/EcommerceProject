...
function Menus() {
  ...
  let searchbar = async () => {
    let response = await axios.get(
      `http://147.93.45.171:1600/menusearch/${search}`
    );
    setUser(response.data);
  };

  let alldata = async () => {
    let response = await axios.get("http://147.93.45.171:1600/menusdata");
    setUser(response.data);
  };
  ...
  let deletedata = async (id) => {
    await axios.delete(`http://147.93.45.171:1600/menusdelete/${id}`, user);
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Menus | RxLYTE" />
      ...
      >
        <div className="sidebar-back h-auto mt-1">
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb ms-2 cart-cart d-flex flex-wrap flex-lg-nowrap">
          ...
          <li className="breadcrumb-item fw-medium text-dark">APPEARENCE</li>
          <li className="breadcrumb-item fw-medium text-dark">MENUS</li>
        </ol>
      </nav>
          ...
          <div className="card-body">
            <div className="d-flex justify-content-between mb-3">
              <div className="d-flex flex-row w-100">
                ...
                <input
                  className="form-control py-4 mt-2 mt-lg-0 rounded-2 w-25 ms-0 border"
                  placeholder="Search..."
                  type="search"
                  name="search"
                  value={search}
              ...
              <div className="mt-2 mt-lg-0 d-flex flex-row">
                <Link to="/admin/menus/create" className="text-decoration-none">
                  <button
                    ...
                    paginatedData.map((data, key) => (
                      <tr key={key}>
                        ...
                        <td style={{ whiteSpace: "nowrap" }}>
                          <span className="badge bg-success fw-light text-info-fg me-1 py-2 fw-bol navigation">
                            Main Navigation
                          </span>
                        </td>
                        ...
                        <td style={{ whiteSpace: "nowrap" }}>
                          <svg
                            className="icon  svg-icon-ti-ti-link text-dark me-1"
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
