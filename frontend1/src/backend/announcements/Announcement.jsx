...
function Announcement() {
  ...
  let searchbar = async () => {
    let response = await axios.get(
      `http://147.93.45.171:1600/search/${search}`
    );
    setUser(response.data);
  };

  let alldata = async () => {
    let response = await axios.get("http://147.93.45.171:1600/getannounce");
    setUser(response.data);
  };
  ...
  let deletedata = async (id) => {
    await axios.delete(`http://147.93.45.171:1600/deleteannoune/${id}`, user);
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Announcements | RxLYTE</title>
        ...
        <meta property="og:title" content="Announcements | RxLYTE" />
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb ms-lg-3">
          ...
          <li className="breadcrumb-item fw-medium text-dark">ANNOUNCEMENTS</li>
        </ol>
      </nav>
          ...
          <div className="card-body">
            <div className="d-flex justify-content-between mb-3">
              <div className="d-flex flex-row w-100">
                ...
                <input
                  className="form-control py-4 mt-2 mt-lg-0 rounded-2 w-50 border ms-0 cart-cart"
                  placeholder="Search..."
                  type="search"
                  name="search"
                  value={search}
