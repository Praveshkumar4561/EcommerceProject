...
function SimpleSliders() {
  ...
  let serachbar = async () => {
    const response = await axios.get(
      `http://52.9.253.67:1600/searchslider/${search}`
    );
  ...
  let showdata = async () => {
    let response = await axios.get("http://52.9.253.67:1600/sliderdata");
    setUser(response.data);
  };

  let deletedata = async (id) => {
    try {
      await axios.delete(`http://52.9.253.67:1600/slidersdelete/${id}`);
      alert("data deleted");
    } catch (error) {
            ...
            <div class="d-flex justify-content-between mb-3">
              <div class="d-flex flex-row w-100">
                ...
                <div className="search-gallery">
                  <input
                    class="form-control py-4 mt-2 mt-lg-0 rounded-2"
                    placeholder="Search..."
                    type="text"
                    name="search"
                    value={search}
