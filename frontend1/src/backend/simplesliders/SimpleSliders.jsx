...
function SimpleSliders() {
  ...
  let serachbar = async () => {
    const response = await axios.get(
      `http://147.93.45.171:1600/searchslider/${search}`
    );
    setUser(response.data);
  };

  let showdata = async () => {
    let response = await axios.get("http://147.93.45.171:1600/sliderdata");
    setUser(response.data);
  };
  ...
  let deletedata = async (id) => {
    await axios.delete(`http://147.93.45.171:1600/slidersdelete/${id}`);
