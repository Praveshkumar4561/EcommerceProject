...
function SimpleSliders() {
  ...
  let serachbar = async () => {
    const response = await axios.get(
      `https://demo.webriefly.com/api/searchslider/${search}`
    );
    setUser(response.data);
  };

  let showdata = async () => {
    let response = await axios.get("https://demo.webriefly.com/api/sliderdata");
    setUser(response.data);
  };
  ...
  let deletedata = async (id) => {
    await axios.delete(`https://demo.webriefly.com/api/slidersdelete/${id}`);
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Simple Sliders | RxLYTE</title>
        ...
        <meta
          ...
          content="Copyright 2025 © RxLYTE. All rights reserved."
        />
        <meta property="og:title" content="Simple Sliders | RxLYTE" />
      ...
      >
        <div className="sidebar-simple mt-1 h-auto">
            ...
            <div className="d-flex justify-content-between mb-3">
              <div className="d-flex flex-row w-100">
                ...
                <div className="search-gallery">
                  <input
                    className="form-control py-4 mt-2 mt-lg-0 rounded-2 border ms-0 cart-cart"
                    placeholder="Search..."
                    type="search"
                    name="search"
                    value={search}
              ...
              <div className="d-flex w-100 justify-content-end">
                <div className="mt-2 mt-lg-0 ms-lg-2 ms-xl-0 ms-xxl-0">
                  <Link to="/admin/simple-sliders/create">
                    <button
