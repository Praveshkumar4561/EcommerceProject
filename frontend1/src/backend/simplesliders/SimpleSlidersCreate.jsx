...
function SimpleSlidersCreate() {
  ...
  const validateForm = () => {
    let newErrors = {};
    const requiredFields = { name, sliderkey, description, date, status };
  ...
  let handleSubmit = async (e) => {
    ...
    const response = await axios.post(
      "https://demo.webriefly.com/api/sliderspost",
      user
    );
    try {
    ...
    <>
      <Helmet>
        ...
        <meta
          ...
          content="Copyright 2025 © RxLYTE. All rights reserved."
        />
        <meta property="og:title" content="New slider | RxLYTE" />
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb d-flex flex-wrap">
          ...
          <li className="breadcrumb-item fw-normal">
            <Link to="/admin/simple-sliders">SIMPLE SLIDERS</Link>
          </li>
          <li className="breadcrumb-item fw-medium text-dark">NEW SLIDER</li>
        </ol>
      </nav>
...
export default SimpleSlidersCreate;
