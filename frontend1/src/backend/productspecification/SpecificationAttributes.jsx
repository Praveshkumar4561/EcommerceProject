...
function SpecificationAttributes() {
  ...
  const searchbar = async () => {
    try {
      let response = await axios.get(
        `http://89.116.170.231:1600/specificationattributesearch/${search}`,
        user
      );
  ...
  const alldata = async () => {
    let response = await axios.get(
      "http://89.116.170.231:1600/spceficationattributedata"
    );
    setUser(response.data);
  };
  ...
  let deletedata = async (id) => {
    await axios.delete(
      `http://89.116.170.231:1600/specificationdeleteattribute/${id}`,
      user
    );
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Specification Attributes | RxLYTE</title>
        ...
        <meta
          ...
          content="Copyright 2025 © RxLYTE. All rights reserved."
        />
        <meta property="og:title" content="Specification Attributes | RxLYTE" />
            ...
            <div className="d-flex justify-content-between mb-3 flex-row">
              ...
              <div className="d-flex w-100 justify-content-end">
                <div className="mt-2 mt-lg-0 ms-lg-2 ms-xl-0 ms-xxl-0 ms-auto">
                  <Link to="/admin/ecommerce/specification-attributes/create">
                  ...
                  {Array.isArray(paginatedData) && paginatedData.length > 0 ? (
                    paginatedData.map((data, key) => (
                      <tr key={key}>
                        ...
                        <td>
                          <Link
                            to={`/admin/ecommerce/specification-attributes/edit/${data.id}`}
                          >
                            {data.name}
                          </Link>
                        </td>
