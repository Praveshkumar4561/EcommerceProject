...
function SpecificationGroup() {
  ...
  const searchbar = async () => {
    try {
      let response = await axios.get(
        `https://demo.webriefly.com/api/specificationsearch/${search}`,
        user
      );
  ...
  let deletedata = async (id) => {
    await axios.delete(
      `https://demo.webriefly.com/api/specificationdelete/${id}`,
      user
    );
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Specification Groups | RxLYTE</title>
        ...
        <meta
          ...
          content="Copyright 2025 © RxLYTE. All rights reserved."
        />
        <meta property="og:title" content="Specification Groups | RxLYTE" />
      ...
      <main className="col-md-9 ms-sm-auto col-lg-10 ms-lg-2 px-md-4 table-announce w-auto d-flex justify-content-center align-items-center cart-cart">
          ...
          <div className="card-body">
            <div className="d-flex justify-content-between mb-3 flex-row">
              <div className="d-flex">
                ...
                <input
                  className="form-control py-4 rounded-2 bulk mt-2 mt-lg-0 border bulk-group"
                  placeholder="Search..."
                  type="search"
                  name="search"
                  value={search}
              ...
              <div className="d-flex w-100 justify-content-end">
                <div className="mt-2 mt-lg-0 ms-lg-2 ms-xl-0 ms-xxl-0 ms-auto">
                  <Link to="/admin/ecommerce/specification-groups/create">
                  ...
                  {Array.isArray(paginatedData) && paginatedData.length > 0 ? (
                    paginatedData.map((data, key) => (
                      <tr key={key}>
                        ...
                        <td>
                          <Link
                            to={`/admin/ecommerce/specification-groups/edit/${data.id}`}
                          >
                            {data.name}
                          </Link>
                        </td>
