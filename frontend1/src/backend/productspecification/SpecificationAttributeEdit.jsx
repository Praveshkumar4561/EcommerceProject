...
function SpecificationAttributeEdit() {
  ...
  let handleSubmit = async (e) => {
    ...
    try {
      await axios.put(
        `http://89.116.170.231:1600/spceficationupdateattribute/${id}`,
        user
      );
  ...
  let somedata = async () => {
    let response = await axios.get(
      `http://89.116.170.231:1600/spceficationdatasomeattribute/${id}`
    );
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Edit Specification Attribute "{user.name}" | RxLYTE</title>
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb d-flex flex-wrap">
          ...
          <li className="breadcrumb-item fw-medium">
            <Link to="/admin/ecommerce/specification-attributes">
              SPECIFICATION ATTRIBUTES
            </Link>
          </li>

          <li className="breadcrumb-item fw-medium ms-0 text-dark">
            EDIT "{user.name}"
          </li>
        </ol>
      </nav>
      ...
      <div className="container-fluid">
        <div className="container">
          <div className="row version-attributes">
            <div className="col-12 col-lg-12 border py-3 rounded bg-light mb-3 text-start">
              <svg
      ...
      <div className="container-fluid">
        <div className="container">
          <div className="row mt-0 ps-lg-3 ms-lg-5 lorem-publish d-flex flex-row flex-md-nowrap flex-wrap flex-lg-wrap flex-xl-nowrap ms-1 ms-lg-0">
            <div className="col-12 col-md-12 col-lg-9 border rounded text-start">
              <form>
                ...
                <div className="mb-3">
                  <label htmlFor="description">
                    Field Type <span className="text-danger fw-bold">*</span>
                  </label>
                  <select
                    className="form-select mt-2 input-text"
                    style={{ height: "50px" }}
                    name="fieldtype"
                    value={fieldtype}
                ...
                {(fieldType === "select" || fieldType === "radio") && (
                  <div className="mb-3">
                    <h4>Options</h4>
                    <hr />
                    <p className="bg-light">Options</p>
                    <hr />
                    <div className="d-flex flex-column gap-3">
                      {options.map((option, index) => (
                        <div className="d-flex flex-row gap-3" key={index}>
                          <input
                            ...
                            className="form-control mb-0 py-4 input-text1"
                          />
                          <FontAwesomeIcon
                            icon={faTrashCan}
                            className="border px-3 py-3 rounded text-danger bg-light"
                            style={{ cursor: "pointer" }}
                      ...
                      <hr />
                      <button
                        className="btn btn-success d-flex flex-row align-items-center py-4 btn-option"
            ...
            <div className="col-12 col-md-12 col-lg-3 border rounded mt-3 mt-md-0 ms-lg-2 ms-0 mt-lg-3 mt-xxl-0 mt-xl-0 lorem-publish1 ms-md-2 mb-4 mb-lg-0">
              <h5 className="mt-3 text-start">Publish</h5>
              <hr />
              <div className="d-flex flex-row mb-3 gap-2 ms-2">
                <button
                  className="btn btn-success d-flex py-4 px-3 flex-row align-items-center"
                  type="submit"
...
export default SpecificationAttributeEdit;
