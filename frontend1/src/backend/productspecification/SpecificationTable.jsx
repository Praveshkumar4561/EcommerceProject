...
function SpecificationTable() {
  ...
  const searchbar = async () => {
    try {
      let response = await axios.get(
        `https://demo.webriefly.com/api/specificationtablesearch/${search}`,
        user
      );
  ...
  const alldata = async () => {
    let response = await axios.get(
      "https://demo.webriefly.com/api/spceficationtabledata"
    );
    setUser(response.data);
  };
  ...
  let deletedata = async (id) => {
    await axios.delete(
      `https://demo.webriefly.com/api/specificationdeletetable/${id}`,
      user
    );
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Specification Tables | RxLYTE</title>
            ...
            <div className="d-flex justify-content-between mb-3 flex-row">
              ...
              <div className="d-flex w-100 justify-content-end">
                <div className="mt-2 mt-lg-0 ms-lg-2 ms-xl-0 ms-xxl-0 ms-auto">
                  <Link to="/admin/ecommerce/specification-tables/create">
