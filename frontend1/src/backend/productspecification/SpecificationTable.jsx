...
function SpecificationTable() {
  ...
  const searchbar = async () => {
    try {
      let response = await axios.get(
        `http://54.183.54.164:1600/specificationtablesearch/${search}`,
        user
      );
  ...
  const alldata = async () => {
    let response = await axios.get(
      "http://54.183.54.164:1600/spceficationtabledata"
    );
    setUser(response.data);
  };
  ...
  let deletedata = async (id) => {
    await axios.delete(
      `http://54.183.54.164:1600/specificationdeletetable/${id}`,
      user
    );
    alert("data deleted");
  };
