...
function SpecificationTableCreate() {
  ...
  let handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        "http://89.116.170.231:1600/specificationtable",
        formData
      );
      setErrors({});
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Create Specification Table | RxLYTE</title>
        ...
        <meta
          property="og:title"
          content="Create Specification Table | RxLYTE"
        />
            ...
            <div className="col-12 col-md-12 col-lg-9 border rounded text-start">
              <form>
                <div className="mt-3">
                  ...
                  <input
                    type="text"
                    className="form-control mt-2 py-4 mb-1 input-text"
                    placeholder="Name"
                    name="name"
                    value={name}
                  ...
                  />
                  {errors.name && (
                    <p className="text-danger cart-cart">{errors.name}</p>
                  )}
                </div>
                ...
                <div className="mt-3">
                  ...
                  />
                  {errors.description && (
                    <p className="text-danger cart-cart">
                      {errors.description}
                    </p>
                  )}
                </div>
                ...
                <div className="mt-3">
                  ...
                  />
                  {errors.date && (
                    <p className="text-danger cart-cart">{errors.date}</p>
                  )}
                </div>
...
export default SpecificationTableCreate;
