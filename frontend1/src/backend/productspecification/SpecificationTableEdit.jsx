...
function SpecificationTableEdit() {
  ...
  const { name, description, date, display } = user;
  ...
  let handleSubmit = async (e) => {
    ...
    const displayValues = selectedGroups.join(", ");
    ...
    try {
      await axios.put(
        `https://demo.webriefly.com/api/spceficationupdatetable/${id}`,
        formData
      );
      setErrors({});
  ...
  let somedata = async () => {
    let response = await axios.get(
      `https://demo.webriefly.com/api/spceficationdatasometable/${id}`
    );
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Edit Specification Table "{user.name}" | RxLYTE</title>
        ...
        <meta
          property="og:title"
          content="Create Specification Tables | RxLYTE"
        />
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb d-flex flex-wrap">
          ...
          <li className="breadcrumb-item fw-medium">
            <Link to="/admin/ecommerce/specification-tables">
              SPECIFICATION TABLES
            </Link>
          </li>
          ...
          <div className="row mt-4 ps-lg-3 ms-lg-5 lorem-publish d-flex flex-row flex-md-nowrap flex-wrap flex-lg-wrap flex-xl-nowrap ms-1 ms-lg-0">
            <div className="col-12 col-md-12 col-lg-9 border rounded text-start">
              <form>
                <div className="mt-3">
                  <label htmlFor="name">
                    Group name <span className="text-danger fw-bold">*</span>
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  ...
                  <div className="d-flex flex-row gap-2 mt-1 mb-3">
                    {list.map((data, index) => (
                      <div key={index}>
                        <input
                          type="checkbox"
                          ...
                          value={data.name}
                          checked={selectedGroups.includes(data.name)}
                          onChange={handleCheckboxChange}
                        />
                        <label className="ms-2">{data.name}</label>
                      </div>
                    ))}
                  </div>
                  ...
                  <table className="table table-bordered table-striped border">
                    <thead className="bg-light">
                      <tr>
                        <th className="fw-light ps-3 py-2">Group Name</th>
                        <th className="fw-light">Sorting</th>
                      </tr>
                    </thead>
                    <tbody>
                      {Array.isArray(edit) && edit.length > 0 ? (
                        edit.map((data, key) => {
                          const displayValue = data.display || "No Name";
                          return (
                            <tr key={key}>
                              <td>{displayValue}</td>
            ...
            <div className="col-12 col-md-12 col-lg-3 border rounded mt-3 mt-md-0 ms-lg-2 ms-0 mt-lg-3 mt-xxl-0 mt-xl-0 lorem-publish1 ms-md-2">
...
export default SpecificationTableEdit;
