...
import "./SpecificationGroupCreate.css";
...
function SpecificationGroupCreate() {
  ...
  let handleSubmit = async (e) => {
    ...
    try {
      await axios.post("https://demo.webriefly.com/api/specification", user);
      setErrors({});
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Create Specification Groups | RxLYTE</title>
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb d-flex flex-wrap">
          ...
          <li className="breadcrumb-item fw-medium">
            <Link to="/admin/ecommerce/specification-groups">
              SPECIFICATION GROUPS
            </Link>
          </li>
...
export default SpecificationGroupCreate;
