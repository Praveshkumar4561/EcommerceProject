    ...
    <>
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb ms-2">
          ...
          <li className="breadcrumb-item fw-medium text-dark">TESTIMONIALS</li>
        </ol>
      </nav>

      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 table-announce w-auto d-flex  justify-content-center align-items-center">
        <div class="card mt-3 testimonial ms-3 ms-lg-0 table-price">
          <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
              <div class="d-flex flex-row">
                ...
                <button
                  class="btn btn-secondary me-2 py-4 d-flex btn-announ mt-0 mt-lg-0"
                  type="button"
                >
                  Filters
                </button>
                <input
                  class="form-control py-4 rounded-2 mt-0 mt-lg-0"
                  placeholder="Search..."
                  type="text"
                  name="search"
                  value={search}
              ...
              <div className="mt-2 mt-sm-0 mt-lg-0 d-flex flex-row ms-1">
                ...
                <button
                  class="btn btn-reload d-flex flex-row align-items-center border"
                  type="button"
                >
