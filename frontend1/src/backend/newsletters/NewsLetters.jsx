...
function NewsLetters() {
  ...
  return (
    <>
      ...
      >
        <div className="sidebar-news h-auto mt-1">
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb ms-2">
          ...
          <li className="breadcrumb-item fw-medium text-dark">NEWSLETTERS</li>
        </ol>
      </nav>
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
              <div class="d-flex flex-row w-100">
                ...
                <input
                  class="form-control py-4 rounded-2 bulk mt-0 mt-lg-0 mt-2 w-25"
                  placeholder="Search..."
                  type="text"
                  name="search"
                  value={search}
            ...
            <div class="table-responsive">
              <table class="table table-responsive table-striped1">
