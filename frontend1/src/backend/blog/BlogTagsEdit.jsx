...
function BlogTagsEdit() {
  ...
  let handleSubmit = async () => {
    try {
      const response = await axios.put(
        `http://89.116.170.231:1600/blogtagupdate/${id}`,
        user
      );
  ...
  let tagsdata = async () => {
    let response = await axios.get(
      `http://89.116.170.231:1600/blogtagdata/${id}`
    );
        ...
        <div className="container">
          ...
          <div className="card mt-3 seo-metas">
            <div className="card-body d-flex flex-column flex-md-row justify-content-between align-items-center">
              <div className="w-100">
                <h5 className="card-title1 text-start">
                ...
                <div className="lh-base d-flex flex-column">
                  <h5 className="seo-name mt-2">{user.name}</h5>
                  ...
                  <span>
                    ...
                    <span className="card-text text-dark ms-2">
                      {user.description}
                      <div className="border seo-names mt-2"></div>
                      {edit && (
                        <>
                          <div className="mt-3">
