...
function BlogPost() {
  ...
  let searchbar = async () => {
    let response = await axios.get(`http://50.18.56.183:1600/blogpostsearch/${search}`);
  ...
  return (
    <>
      ...
      >
        <div className="sidebar-blog mt-1">
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb ms-2">
          ...
          <li className="breadcrumb-item fw-medium text-dark">POSTS</li>
        </ol>
      </nav>
