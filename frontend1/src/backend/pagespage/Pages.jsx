...
function Pages() {
  ...
  let searchbar = async () => {
    let response = await axios.get(
      `https://demo.webriefly.com/api/pagesearch/${search}`
    );
    setUser(response.data);
  };

  let alldata = async () => {
    let response = await axios.get("https://demo.webriefly.com/api/pagesdata");
    setUser(response.data);
  };
  ...
  let deletedata = async (id) => {
    await axios.delete(
      `https://demo.webriefly.com/api/pagesdelete/${id}`,
      user
    );
    ...
    <>
      <Helmet>
        ...
        <meta
          ...
          content="Copyright 2025 © RxLYTE. All rights reserved."
        />
        <meta property="og:title" content="Pages | RxLYTE" />
      ...
      >
        <div className="sidebar-pages1 h-auto mt-1">
            ...
            <div>
              <li onClick={toggleFAQ} style={{ cursor: "pointer" }}>
                ...
                >
                  <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                  <path
                    d="M12.802 2.165l5.575 2.389c.48 .206 .863 .589 1.07 1.07l2.388 5.574c.22 .512 .22 1.092 0 1.604l-2.389 
                    5.575c-.206 .48 -.589 .863 -1.07 1.07l-5.574 2.388c-.512 .22 -1.092 .22 -1.604 0l-5.575 -2.389a2.036 2.036 
                    0 0 1 -1.07 -1.07l-2.388 -5.574a2.036 2.036 0 0 1 0 -1.604l2.389 -5.575c.206 -.48 .589 -.863 1.07 -1.07l5.574 -2.388a2.036 2.036 0 0 1 1.604 0z"
                  ></path>
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb ms-2 cart-cart d-flex flex-wrap flex-lg-nowrap">
          ...
          <li className="breadcrumb-item fw-medium text-dark">PAGES</li>
        </ol>
      </nav>
