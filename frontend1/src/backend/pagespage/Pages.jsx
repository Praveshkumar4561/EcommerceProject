...
function Pages() {
  ...
  let searchbar = async () => {
    let response = await axios.get(
      `http://52.9.253.67:1600/pagesearch/${search}`
    );
    setUser(response.data);
  };

  let alldata = async () => {
    let response = await axios.get("http://52.9.253.67:1600/pagesdata");
    setUser(response.data);
  };

  let deletedata = async (id) => {
    await axios.delete(`http://52.9.253.67:1600/pagesdelete/${id}`, user);
            ...
            <div class="d-flex justify-content-between mb-3">
              <div class="d-flex flex-row w-100">
                ...
                <div className="search-gallery">
                  <input
                    class="form-control py-4 mt-2 mt-lg-0 rounded-2 w-75"
                    placeholder="Search..."
                    type="text"
                    name="search"
                    value={search}
