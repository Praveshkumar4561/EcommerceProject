...
function InvoiceEdit() {
  ...
  return (
    <>
      ...
      >
        <div className="sidebar-invoice1 mt-1">
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb ms-2 d-flex flex-wrap">
          <li
            className="breadcrumb-item fw-normal cart-cart"
          ...
          <li
            className="breadcrumb-item fw-medium text-dark cart-cart"
            style={{ position: "relative", zIndex: "1000", cursor: "pointer" }}
          >
            <Link to="/admin/ecommerce/invoices">INVOICES</Link>
          </li>
          <li className="breadcrumb-item fw-medium text-dark cart-cart">
            EDIT
            {invoice.map((data) => (
          ...
          <div className="row">
            ...
            >
              {invoice.map((data, key) => (
                <>
                  <div
                    className="d-flex justify-content-lg-end align-items-end w-100"
                    key={key}
                  >
                    <div className="d-flex flex-column text-end w-100">
                      <span className="fw-bold text-lg-end text-end w-100 text-md-end fs-5">
                        Invoice
                      </span>
                      <span className="text-lg-end text-end w-100 mt-2">
                        {data.first_name} <span>{data.last_name}</span>
                      </span>
                      <span className="text-lg-end text-end w-100">
                        {data.email}
                      </span>
                      <span className="text-lg-end text-end w-100">
                        {data.phone_number}
              ...
              <form className="w-100">
                <div className="d-flex flex-row flex-wrap order-edit justify-content-lg-around gap-3 justify-content-around">
                  {invoice.map((data) => (
                    <>
                      ...
                      <div className="d-flex flex-column">
                        <span className="fw-bold">ISSUE AT</span>
                        <span>
                  ...
                  <div className="d-flex flex-column">
                    <Link className="text-decoration-none text-success"></Link>
                  </div>
                  <div style={{ fontFamily: "verdana" }}></div>
                  <div style={{ fontFamily: "verdana" }}></div>
                  <div style={{ fontFamily: "verdana" }}></div>
                </div>
                <hr />
                ...
                <div className="table-container-content">
                  {invoice.map((data, key) => (
                    <table className="table lh-lg" key={key}>
                      <thead className="bg-light border border-end-0 border-start-0">
                        <tr>
                          <th className="py-2 ps-2 fw-light">#</th>
                          <th className="fw-light ps-3">Image</th>
                          <th className="fw-light ps-3">Product</th>
                          <th className="fw-light ps-2">Amount</th>
                          <th className="fw-light ps-2">Quantity</th>
                          <th className="fw-light ps-2">Total</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                        ...
                        <tr>
                          <td colSpan={4}></td>
                          <td style={{ fontFamily: "verdana" }}>Quantity</td>
                          <td
                            style={{ fontFamily: "verdana" }}
                            className="fw-bold"
                          >
                        ...
                        <tr>
                          <td colSpan={4}></td>
                          <td style={{ fontFamily: "verdana" }}>Sub Total</td>
                          <td
                            style={{ fontFamily: "verdana" }}
                            className="fw-bold"
                          >
                        ...
                        <tr>
                          <td colSpan={4}></td>
                          <td style={{ fontFamily: "verdana" }}>Tax</td>
                          <td
                            style={{ fontFamily: "verdana" }}
                            className="fw-bold"
                          >
                        ...
                        <tr>
                          <td colSpan={4}></td>
                          <td style={{ fontFamily: "verdana" }}>Discount</td>
                          <td
                            style={{ fontFamily: "verdana" }}
                            className="fw-bold"
                          >
                        ...
                        <tr>
                          <td colSpan={4}></td>
                          <td style={{ fontFamily: "verdana" }}>Grand Total</td>
                          <td
                            style={{ fontFamily: "verdana" }}
                            className="fw-bold"
                          >
