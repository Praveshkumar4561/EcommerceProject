      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb d-flex flex-wrap">
          ...
          <li className="breadcrumb-item fw-medium ms-2 text-dark">
            VIEW REVIEW "{user.user_name}"
          </li>
        </ol>
      </nav>

      <div className="container-fluid overflow-hidden">
        <div class="container container-create1 d-flex flex-wrap flex-lg-nowrap">
          <div class="row border ms-1 rounded announcement-create me-4 create-tags create-tags1">
            <div class="col-md-12 col-lg-8">
              <form>
                <div class="me-2 mt-4 mb-4 d-flex gap-2 awasome-star d-flex flex-wrap flex-lg-nowrap flex-row">
                  <FontAwesomeIcon icon={faStar} className="fontawasome" />
                  <FontAwesomeIcon icon={faStar} className="fontawasome" />
                  <FontAwesomeIcon icon={faStar} className="fontawasome" />
                  <FontAwesomeIcon icon={faStar} className="fontawasome" />
                  <FontAwesomeIcon icon={faStar} className="fontawasome" />
                  <span class="badge badge-success lh-base px-2 py-1 status-blog product-nam published-butto fw-light">
                    {user.status}
                  </span>
