...
function ReviewsCreate() {
  ...
  return (
    <>
      ...
      >
        <div className="sidebar-back mt-0">
      ...
      <nav className="breadcrumb-container text-cente">
      ...
      {/* <div className="container-fluid mt-lg-5 mt-0">
        <div class="container ms-lg-5 ps-lg-4 ps-0">
          <div class="row border ms-1 rounded container-create2">
            <div class="col-md-12 col-lg-8 w-100">
              <form>
                <div class="flex-column me-2 mt-3">
                  ...
                  <input
                    type="text"
                    class="form-control py-4 progress-review"
                ...
                <div class="flex-column me-2 mt-3 w-100">
                  <label for="name" class="form-label fw-lighter">
                    Choose from existing customers
                  </label>
                  <input
                    type="text"
                    className="form-control py-4 progress-review"
                    placeholder="Product Name"
                  />
                </div>

                <div className="flex-column me-2 mt-4 border rounded enter-manual1 bg-light pb-1">
                  <p className="pt-3 ps-2 fw-mediumm">
                    Or enter manually customer details:
                  </p>
                  <label className="ps-2 pb-2">Customer name</label>
                  <input
                    type="text"
                    className="form-control mb-3 ms-2 py-4 reviews-page1"
                    name="user_name"
                    value={user_name}
                    onChange={onInputChange}
                  />
                  <label className="ps-2 pb-2">Customer email</label>
                  <input
                    type="email"
                    className="form-control mb-3 ms-2 py-4 reviews-page1"
                ...
                <div class="flex-column me-2 mt-3 w-100 reviews-select">
                  <label for="name" class="form-label fw-lighter">
                    Star
                  </label>
                ...
                <div class="col-md-6 mt-3 mb-4 image-car1 w-100">
                  <label for="start-date" class="form-label fw-lighter">
                    Comment <span className="text-danger">*</span>
                  </label>
                  <textarea
                    type="text"
                    class="form-control text-areabox h-aut"
                    id="start-date"
                ...
                <div className="container1 image-car">
                  <div className="image-card w-100 border-0">
                    <label className="text-start float-lg-start mb-2 images-file">
                      Images
                    </label>
                    <div
                      className="image-placeholder border me-5 file-upload d-flex flex-column"
                      onClick={() =>
          ...
          <div class="card-container flex-column container-save pt-2">
            <div class="card card-publish">
              <div class="card-body">
                ...
                <button class="btn btn-secondary ms-3 btn-exit">
            ...
            <div class="card card-active mt-0 mb-">
              <div class="card-body">
                <h5 class="card-title fw-lighter">Status</h5>
                <hr />
                <select
            ...
            <div class="card card-active mt-0 mb-">
              <div class="card-body">
                <h5 class="card-title fw-lighter">Created At</h5>
                <hr />
                <input
                  type="date"
          ...
          <div className="row d-flex flex-row flex-xxl-nowrap flex-xl-nowrap gap-3 w-100 ms-md-1">
            <div className="col-12 col-lg-8 border rounded customer-page customer-page2">
              <form>
                ...
                <div className="w-100 bg-light border rounded px-2 mb-3 mt-2 text-start">
            ...
            <div className="col-12 col-sm-12 col-md-12 col-lg-4 d-flex flex-column gap-3 customer-page1 review-public">
              ...
              <div className="border rounded p-3 customer-page1">
                ...
                <hr />
                <select className="form-select mb-2" style={{ height: "46px" }}>
                  <option value="">Select an option</option>
                  <option value="published">Published</option>
