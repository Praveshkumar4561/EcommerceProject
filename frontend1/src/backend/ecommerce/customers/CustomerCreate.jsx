  ...
  let handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://demo.webriefly.com/api/usersubmit",
        formData
      );
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Create a customer | RxLYTE</title>
      ...
      <div className="container-fluid">
        <div className="container">
          <div className="row d-flex flex-row flex-xxl-nowrap flex-xl-nowrap gap-3 w-100 ms-lg-1 ms-0">
            <div className="col-12 col-lg-8 border rounded customer-page">
              <form>
                ...
                <div className="d-flex flex-row gap-2 name-form text-start flex-wrap flex-lg-nowrap flex-md-nowrap flex-sm-nowrap">
                  <div className="d-flex flex-column mb-3 mt-lg-3 name-form1">
                ...
                <div className="d-flex flex-column">
                  ...
                  {errors.gender && (
                    <small className="text-danger text-start cart-cart mt-0 mb-2">
                      {errors.gender}
                    </small>
                  )}
                </div>
                ...
                <div className="text-start">
                  ...
                  <textarea
                    className="form-control mt-2 mb-1 note-private"
                    name="notes"
                    value={notes}
                    onChange={onInputChange}
                    style={{ height: "68px" }}
