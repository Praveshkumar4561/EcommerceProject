...
function Products() {
  ...
  let deletedata = async (id) => {
    await axios.delete(
      `http://52.9.253.67:1600/deleteproductsdata/${id}`,
      user
    );
  ...
  const handleDownload = async () => {
    try {
      const response = await axios.get(
        "http://52.9.253.67:1600/exportexcel-productdata",
        {
          responseType: "blob",
        }
      );
  ...
  return (
    <>
      ...
      <div
        className={`sidebar-container-backend mt- ${
          isNavbarExpanded && isMobile ? "expanded" : ""
        }`}
      >
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb ms-2">
          ...
          <li className="breadcrumb-item fw-medium text-dark">ECOMMERCE</li>
          <li className="breadcrumb-item fw-medium text-dark">PRODUCTS</li>
        </ol>
      </nav>

      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 table-product d-flex justify-content-center align-items-center w-auto">
        <div class="card mt-3 testimonial table-price ms-2">
          <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
              <div class="d-flex flex-row w-100">
                <div class="btn-group me-2">
                  <button
                    aria-expanded="false"
                    class="btn btn-secondary dropdown-toggle d-flex flex-row align-items-center py-4 btn-announ mt-2 mt-md-2 mt-lg-0"
              ...
              <div className="d-flex w-100 justify-content-end">
                <div className="mt-2 mt-lg-0 ms-lg-2 ms-xl-0 ms-xxl-0 d-sm-flex">
                  ...
                  <div className="btn-group me-2">
                    ...
                    {physical && (
                      <div className="d-flex flex-column w-auto bg-light border px-4 py-0 border rounded mt-5 position-absolute">
                        <ul
                          className="product-digital mt-3 px-1"
                          style={{
                            listStyleType: "none",
                            padding: 0,
                            cursor: "pointer",
                        ...
                        >
                          ...
                          >
                            <li className="d-flex align-items-center mb-2 ms-3 text-dark">
                              <svg
                                className="icon svg-icon-ti-ti-package text-dark digital-svg position-absolute"
                            ...
                            <li className="d-flex align-items-center ms-3 mt-3 text-dark">
                              <svg
                                class="icon  svg-icon-ti-ti-book-download text-dark digital-svg position-absolute"
                                style={{ position: "absolute", left: "12%" }}
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
                  ...
                  <button
                    class="btn btn-reload ms-sm-0 mt-sm-0 d-sm-flex border"
                    type="button"
                  >
