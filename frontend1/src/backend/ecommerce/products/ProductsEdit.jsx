      ...
      <div class="container container-create-gallery">
            ...
            <div className="w-100">
              ...
              <div className="d-flex mb-4">
                <div className="me-2 flex-fill">
                  ...
                  <input
                    type="text"
                    className="form-control py-4 sku-overview"
                    name="sku"
                    value={sku}
                    onChange={onInputChange}
                  />
                ...
                <div className="me-2 flex-fill mt-3 mt-lg-0 sku-overview1">
                ...
                <div className="flex-fill mt-3 mt-lg-0 sku-overview1">
                  <label htmlFor="coupon-condition" className="form-label">
                    Price Sale
                  </label>
                  <input
              ...
              <div className="d-flex mb-4">
                ...
                <div className="me-2 flex-fill mt-4 mt-lg-0 cost-item">
                  <label
              ...
              <div className="border rounded bg-light mt-3">
                <label htmlFor="" className="ms-2 mt-3">
                  Stock status
                </label>
                <div className="d-flex ms-1 ms-lg-2 mt-2 gap-2 mb-3 stock-radio flex-row">
                  <input
                    type="radio"
        ...
        <div className="border ms-1 rounded mt-3 cart-cart bg-body attribute-product d-flex flex-column">
          <div className="d-flex w-100">
            <label
              htmlFor=""
              className="fw-medium cart-cart ms-4 mt-3 flex-grow-1"
            >
              Attributes
            </label>

            <button
              className="btn btn-success ms-auto d-flex me-2 mt-4 new-attribute new-attribute2 bg-body border text-dark py-4"
        ...
        <div class="card mt-3 ms- create-tags1 create-display">
          <div class="card-body d-flex flex-column flex-md-row justify-content-between align-items-center">
            <div>
              ...
              <br />
              <span className="text-success"> {user.permalink}</span>
              <br />
              <span className="text-success"> {user.date}</span>
        ...
        <div class="card-container mt-4 flex-column container-publish me-3">
          <div class="card card-publish">
            <div class="card-body">
              ...
              <div className="d-flex flex-row">
                ...
                <button class="btn btn-secondary ms-2 btn-exit d-flex">
                  <i class="fas fa-sign-out-alt me-1"></i>
                  <Link
                    to="http://localhost:5173/admin/ecommerce/products"
                    className="text-light text-decoration-none"
                  >
                    Save & Exit
                  </Link>
              ...
              >
                {imageUrl ? (
                  ...
                  <img
                    ...
                    className="w-100 h-100 img-thumbnail rounded-1"
                  />
                )}
              </div>
              <input
          ...
          <div class="card card-active mt-0 mb-">
            <div class="card-body">
              <h5 class="card-title1 fw-lighter">Minimum order quantity</h5>
              <hr />
              <input
                type="number"
                className="form-control py-4"
          ...
          <div class="card card-active mt-0 mb-">
            <div class="card-body">
              <h5 class="card-title1 fw-lighter">Maximum order quantity</h5>
              <hr />
              <input
                type="number"
                className="form-control py-4"
