...
function ProductCollections() {
  ...
  let searchbar = async () => {
    let response = await axios.get(
      `http://52.9.253.67:1600/searchcollections/${search}`
    );
    setUser(response.data);
  };

  let alldata = async () => {
    let response = await axios.get("http://52.9.253.67:1600/collectionsdata");
    setUser(response.data);
  };

  let deletedata = async (id) => {
    await axios.delete(`http://52.9.253.67:1600/collectiondelete/${id}`, user);
  ...
  return (
    <>
      ...
      <nav className="breadcrumb-container text-center collections">
        ...
        <div class="card mt-3 testimonial">
          <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
              ...
              <div className="mt-2 mt-sm-0 mt-lg-0 d-flex flex-row ms-1">
                <Link to="/admin/ecommerce/product-collections/create">
                  <button
                ...
                <button
                  class="btn btn-reload bulk d-flex flex-row align-items-center border"
                  type="button"
                >
      ...
      <div class="container">
        <div class="footer mt-lg-5 pt-lg-5">
          <div class="left">
