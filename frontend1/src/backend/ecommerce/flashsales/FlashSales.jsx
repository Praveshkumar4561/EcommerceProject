...
function FlashSales() {
  ...
  let searchbar = async () => {
    let response = await axios.get(`http://50.18.56.183:1600/searchflash/${search}`);
    ...
    <>
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb ms-2">
          ...
          <li className="breadcrumb-item fw-medium text-dark">FLASH SALES</li>
        </ol>
      </nav>
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
              ...
              <div className="mt-2 mt-sm-0 mt-lg-0 d-flex ms-2 flex-row">
                <Link
                  to="/admin/ecommerce/flash-sales/create"
