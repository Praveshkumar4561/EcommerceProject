...
function DiscountsEdit() {
  ...
  const handleSubmit = async () => {
    try {
      const response = await axios.put(
        `https://demo.webriefly.com/api/discountupdate/${id}`,
        user
      );
  ...
  let somedata = async () => {
    let response = await axios.get(
      `https://demo.webriefly.com/api/discountsomedata/${id}`
    );
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Edit discount | RxLYTE</title>
      ...
      <div className="container-fluid cart-cart">
        <div className="container">
          <div className="row d-flex flex-row flex-xxl-nowrap flex-xl-nowrap gap-3 customer-page w-auto">
            <div className="col-12 col-lg-8 border rounded">
              <form>
                ...
                <div className="d-flex flex-row gap-2 name-form text-start flex-wrap flex-md-nowrap flex-lg-nowrap flex-sm-nowrap">
                  <div className="d-flex flex-column mb-3 mt-0 name-for w-100 coupon-container coupon-option">
                ...
                <div className="d-flex flex-row gap-2 mt-2">
                  ...
                  <label htmlFor="">Can be Used with promotion?</label>
                </div>
                ...
                <div className="d-flex flex-row gap-2 mt-2">
                  ...
                  />
                  <label>Unlimited Coupon?</label>
                </div>

                {!isChecked && (
                  <div className="d-flex flex-row gap-2 name-form text-start flex-wrap flex-lg-nowrap flex-md-nowrap flex-sm-nowrap mt-0">
                ...
                <div className="d-flex flex-row gap-2 mt-2">
                  ...
                  <div className="d-flex flex-column">
                    <label htmlFor="">Apply via URL?</label>
                    <label htmlFor="" style={{ fontSize: "13px" }}>
                      This setting will apply coupon code when customers access
                      the URL with the parameters "?coupon=code".
                    </label>
                  </div>
                </div>
                ...
                <div className="d-flex flex-row gap-2 mt-2 mb-4">
                  ...
                  <div className="d-flex flex-column text-start">
                    ...
                    <label htmlFor="" style={{ fontSize: "13px" }}>
                      The list of coupon codes will be displayed at the checkout
                      page and customers can choose to apply.
                    </label>
                  </div>
                </div>
                <hr />
                ...
                <div className="text-start">
                  ...
                  <div className="d-flex flex-row gap-4 mt-2 mb-3 flex-wrap flex-lg-nowrap">
                    <select
            ...
            <div className="col-12 col-sm-12 col-md-12 col-lg-4 d-flex flex-column gap-3 cart-cart">
              <div className="border rounded p-2 customer-page1">
                <h4 className="mt-0 text-start">Time</h4>
                <hr />
