...
function Discounts() {
  ...
  let searchbar = async () => {
    let response = await axios.get(
      `http://147.93.45.171:1600/discountsearch/${search}`
    );
    setUser(response.data);
  };

  let alldata = async () => {
    let response = await axios.get("http://147.93.45.171:1600/discountdata");
    setUser(response.data);
  };
  ...
  let deletedata = async (id) => {
    await axios.delete(`http://147.93.45.171:1600/discountdelete/${id}`, user);
