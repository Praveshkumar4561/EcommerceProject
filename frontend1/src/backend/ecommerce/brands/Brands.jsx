...
function Brands() {
  ...
  let searchbar = async () => {
    let response = await axios.get(
      `http://89.116.170.231:1600/searchbrand/${search}`
    );
  ...
  let deletedata = async (id) => {
    await axios.delete(`http://89.116.170.231:1600/deletebrands/${id}`, user);
    try {
                  ...
                  {Array.isArray(user) && user.length > 0 ? (
                    user.map((data, key) => (
                      <tr key={key}>
                        ...
                        <td>
                          <span className="badge badge-success fw-light lh-base px-2 py-1 status-blog">
                            {data.status}
                          </span>
                        </td>
