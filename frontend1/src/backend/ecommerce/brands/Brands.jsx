...
function Brands() {
  ...
  let searchbar = async () => {
    let response = await axios.get(
      `http://52.9.253.67:1600/searchbrand/${search}`
    );
  ...
  let deletedata = async (id) => {
    await axios.delete(`http://52.9.253.67:1600/deletebrands/${id}`, user);
    ...
    <>
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb ms-2">
          ...
          <li className="breadcrumb-item fw-medium text-dark">BRANDS</li>
        </ol>
      </nav>
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
              ...
              <div className="mt-2 mt-sm-0 mt-lg-0 d-flex ms-1 flex-row">
                <Link
                  to="/admin/ecommerce/brands/create"
