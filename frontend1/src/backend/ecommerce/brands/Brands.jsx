...
function Brands() {
  ...
  let searchbar = async () => {
    let response = await axios.get(
      `https://demo.webriefly.com/api/searchbrand/${search}`
    );
    setUser(response.data);
  };

  let alldata = async () => {
    let response = await axios.get("https://demo.webriefly.com/api/brandsdata");
    setUser(response.data);
  };
  ...
  let deletedata = async (id) => {
    await axios.delete(
      `https://demo.webriefly.com/api/deletebrands/${id}`,
      user
    );
    ...
    <>
      <Helmet>
        ...
        <meta
          ...
          content="Copyright 2025 © RxLYTE. All rights reserved."
        />
        <meta property="og:title" content="Brands | RxLYTE" />
                    ...
                    paginatedData.map((data, key) => (
                      <tr key={key}>
                        ...
                        <td>
                          <Link to="#">
                            {" "}
                            <span className="badge badge-success lh-base fw-light py-1 px-2 status-blog">
                              {data.featured}
                            </span>
                          </Link>
                        </td>
