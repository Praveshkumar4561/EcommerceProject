...
function ProductAttributes() {
  ...
  let searchbar = async () => {
    let response = await axios.get(
      `http://89.116.170.231:1600/attributesearch/${search}`
    );
    setUser(response.data);
  };

  let alldata = async () => {
    let response = await axios.get("http://89.116.170.231:1600/attributesdata");
    setUser(response.data);
  };
  ...
  let deletedata = async (id) => {
    try {
      await axios.delete(
        `http://89.116.170.231:1600/attrubutedelete/${id}`,
        user
      );
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Product attributes | RxLYTE</title>
        ...
        <meta
          ...
          content="Copyright 2025 © RxLYTE. All rights reserved."
        />
        <meta property="og:title" content="Product attributes | RxLYTE" />
          ...
          <div className="card-body">
            <div className="d-flex justify-content-between mb-3">
              <div className="d-flex flex-row">
                <div className="btn-group me-2 group-attribute">
                  <button
                    aria-expanded="false"
              ...
              <div className="mt-2 mt-lg-0 d-flex ms-1 mt-sm-0 d-flex flex-row">
                <Link
                  to="/admin/ecommerce/product-attribute-sets/create"
                ...
                <button
                  className="btn btn-reload border bulk d-flex flex-row align-items-center"
                  type="button"
                >
