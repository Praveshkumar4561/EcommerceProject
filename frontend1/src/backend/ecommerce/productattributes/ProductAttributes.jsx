...
function ProductAttributes() {
  ...
  let searchbar = async () => {
    let response = await axios.get(`http://50.18.56.183:1600/attributesearch/${search}`);
  ...
  let deletedata = async (id) => {
    await axios.delete(`http://50.18.56.183:1600/attrubutedelete/${id}`, user);
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
              <div class="d-flex flex-row">
                <div class="btn-group me-2 group-attribute">
                  <button
                    aria-expanded="false"
              ...
              <div className="mt-2 mt-lg-0 d-flex ms-1 mt-sm-0 d-flex flex-row">
                <Link to="/admin/ecommerce/product-attribute-sets/create">
                  <button
                ...
                <button
                  class="btn btn-reload border bulk d-flex flex-row align-items-center"
                  type="button"
                >
                  ...
                  {Array.isArray(user) && user.length > 0 ? (
                    user.map((data, key) => (
                      <tr key={key}>
                        ...
                        <td>
                          <Link
                            to={`/admin/ecommerce/product-attribute-sets/edit/${data.id}`}
                          >
                            {data.title}
                          </Link>
                        </td>
                        ...
                        <td className="ps-5" style={{ fontFamily: "verdana" }}>
                          {data.sort}
                        </td>
