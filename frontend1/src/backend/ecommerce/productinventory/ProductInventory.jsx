  ...
  const reloadInvent = async (id, updatedUserData) => {
    ...
    try {
      ...
      const response = await axios.put(
        `http://52.9.253.67:1600/productinventory/${id}`,
        updatedData
      );
  ...
  return (
    <>
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 table-announce w-auto d-flex justify-content-center align-items-center">
        <div class="card mt-3 testimonial border">
          <div class="card-body">
            <div class="d-flex justify-content-between mb-3 flex-row">
              <div class="d-flex">
                <div class="btn-group me-2 group-attribute"></div>
                <input
                  class="form-control py-4 rounded-2 bulk mt-2 mt-lg-0"
                  placeholder="Search..."
                  type="text"
                  name="search"
                  value={search}
