...
function Orders() {
  ...
  let searchbar = async () => {
    let response = await axios.get(
      `http://52.9.253.67:1600/customerget/${search}`
    );
  ...
  const handleDownload = async () => {
    try {
      const response = await axios.get("http://52.9.253.67:1600/order-export", {
        responseType: "blob",
      });
      ...
      if (response.data.size > 0) {
        ...
        link.href = url;
        link.setAttribute("download", "Order Table.xlsx");
  ...
  return (
    <>
      ...
      >
        <div className="sidebar-orders mt-1 h-auto">
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb ms-lg-3">
        ...
        <div class="card mt-3 testimonial table-price ms-3 ms-lg-3">
          <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
              ...
              <div className="d-flex justify-content-end w-100 d-sm-flex ms-sm-2">
                <div className="mt-2 mt-lg-0 ms-lg-2 ms-xl-0 ms-xxl-0 d-flex flex-row">
                  <Link
                    to="/admin/ecommerce/orders/create"
                    className="text-decoration-none"
                  >
                    <button
                      class="btn btn-create me-2 d-flex flex-row align-items-center"
                      type="button"
                    >
                  ...
                  <button
                    class="btn btn-create me-2 bulk bg-secondary text-light d-flex flex-row align-items-center"
                    type="button"
                  >
                    <FontAwesomeIcon
                      icon={faDownload}
                  ...
                  <button
                    class="btn btn-reload border mt-sm-0 mt-md-0 d-flex flex-row align-items-center"
                    type="button"
                  >
