...
function ProductLabels() {
  ...
  let searchbar = async () => {
    let response = await axios.get(
      `http://147.93.45.171:1600/searchlabels/${search}`
    );
  ...
  let deletedata = async (id) => {
    await axios.delete(`http://147.93.45.171:1600/deletelabels/${id}`, user);
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Product labels | RxLYTE</title>
        ...
        <meta
          ...
          content="Copyright 2025 © RxLYTE. All rights reserved."
        />
        <meta property="og:title" content="Product labels | RxLYTE" />
                ...
                <thead className="table-secondary">
                  <tr>
                    ...
                    <th scope="col" className="fw-light">
                      <span className="d-flex flex-row">ID</span>
                    </th>
