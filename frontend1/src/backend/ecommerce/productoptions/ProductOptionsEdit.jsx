    ...
    <>
      ...
      <div class="container container-create-gallery">
        ...
        <div className="ms-1 border mt-3 rounded ps-4 pt-2 align-items-center justify-content-center product-row">
          ...
          <hr className="me-4" />
          {showTable && (
            <table className="table table-responsive-lg table-bordered table-striped">
              <thead className="fw-light">
                <th className="pt-2 pb-2">#</th>
                <th>Label</th>
                <th className="text-start">Price</th>
                <th
                  className="text-start pe-5"
              ...
              <tbody>
                {rows.map((row, index) => (
                  <tr key={index}>
                    <td>
                      <svg
                        className="icon svg-icon-ti-ti-arrows-sort text-black"
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                    ...
                    <td>
                      <FontAwesomeIcon
                        icon={faTrashCan}
                        className="border border-success px-2 py-2 rounded"
                        onClick={() => {
              ...
              <button
                className="mt-3 border rounded px-3 py-2 bg-light"
                onClick={addRow}
                style={{ whiteSpace: "nowrap" }}
              >
        ...
        <div class="card-container mt-4 flex-column container-publish me-3">
          <div class="card card-publish">
            <div class="card-body">
              ...
              <hr />
              <button class="btn btn-save" type="submit" onClick={handleSubmit}>
