...
function ProductOptions() {
  ...
  let searchbar = async () => {
    let response = await axios.get(
      `https://demo.webriefly.com/api/searchproductoption/${search}`
    );
  ...
  let deletedata = async (id) => {
    await axios.delete(
      `https://demo.webriefly.com/api/deleteproductoptions/${id}`,
      user
    );
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Product options | RxLYTE</title>
        ...
        <meta
          ...
          content="Copyright 2025 © RxLYTE. All rights reserved."
        />
        <meta property="og:title" content="Product options | RxLYTE" />
          ...
          <div className="card-body">
            <div className="d-flex justify-content-between mb-3">
              ...
              <div className="mt-2 mt-sm-0 mt-lg-0 d-flex ms-2 flex-row">
                <Link
                  to="/admin/ecommerce/options/create"
                ...
                <thead className="table-secondary">
                  <tr>
                    ...
                    <th scope="col" className="fw-light">
                      <span className="d-flex mt-1 d-flex flex-row">ID</span>
                    </th>
