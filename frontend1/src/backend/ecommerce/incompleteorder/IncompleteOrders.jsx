      ...
      <div className="container-fluid overflow-hidden">
        <div className="container">
          {incomplete.length === 0 ? (
            ...
            <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4 table-announce d-flex justify-content-center align-items-center position-absolute start-0 w-100">
                ...
                <div className="card-body">
                  <div className="d-flex justify-content-between mb-3">
                    <div className="d-flex flex-row w-100">
                      ...
                      <button
                        className="btn btn-secondary me-2 mt-2 mt-lg-0 py-4 d-flex cart-cart"
                        type="button"
                      >
                        Filters
                      </button>
                      ...
                      <div className="search-gallery">
                        <input
                          className="form-control py-4 mt-2 mt-lg-0 rounded-2 cart-cart"
                          placeholder="Search..."
                          type="text"
                        />
                      </div>
                        ...
                        {incomplete.map((data, key) => (
                          <tr key={key}>
                            ...
                            <td style={{ whiteSpace: "nowrap" }}>
                              <button
                                className="btn btn-edit me-2 px-2"
                                type="button"
                              >
                                <Link>
                                  <FontAwesomeIcon
