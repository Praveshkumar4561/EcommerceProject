...
function IncompleOrders() {
  ...
  return (
    <>
      ...
      >
        <div className="sidebar-invoice mt-1">
      ...
      <nav className="breadcrumb-container text-center inventory-typo1">
        <ol className="breadcrumb d-flex flex-wrap">
          ...
          <li className="breadcrumb-item fw-normal">
            <Link to="/admin/ecommerce/orders">ORDERS</Link>
          </li>
      ...
      <div className="container-fluid overflow-hidden">
        <div className="container">
          {incomplete.length === 0 ? (
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 table-announce d-flex justify-content-center align-items-center position-absolute start-0 w-100">
                  ...
                  <div class="d-flex justify-content-between mb-3">
                    <div class="d-flex flex-row w-100">
                      <div class="btn-group me-2">
                        <button
                          aria-expanded="false"
                          class="btn btn-secondary dropdown-toggle d-flex flex-row align-items-center py-4 btn-announ mt-2 mt-md-2 mt-lg-0 cart-cart"
                      ...
                      <button
                        class="btn btn-secondary me-2 mt-2 mt-lg-0 py-4 d-flex cart-cart"
                        type="button"
                      >
                        Filters
                      </button>
                      ...
                      <div className="search-gallery">
                        <input
                          class="form-control py-4 mt-2 mt-lg-0 rounded-2 cart-cart"
                          placeholder="Search..."
                          type="text"
                        />
                      </div>
                      ...
                      <div className="mt-2 mt-lg-0 ms-lg-0 ms-xl-0 ms-xxl-0 d-flex flex-row">
                        ...
                        >
                          ...
                          <span style={{ whiteSpace: "nowrap" }}>
                            <Link
                              className="text-light text-decoration-none"
                              to="/admin/ecommerce/orders/create"
                            >
                              Create
                            </Link>
                          </span>
                        ...
                        <button
                          className="btn border me-1 text-light invoice-typex d-flex flex-row align-items-center py-lg-4 py-sm-4 ms-sm-1 me-2 btn-light"
                          type="button"
                        >
                          <FontAwesomeIcon
                            icon={faDownload}
                        ...
                        <button
                          class="btn btn-reload border cart-cart d-flex flex-row align-items-center border"
                          type="button"
                        >
                      ...
                      <tbody>
                        {incomplete.map((data, key) => (
                          <tr key={key}>
                            ...
                            <td>
                              <span className="sliders1">{data.store}</span>
                            </td>

                            <td style={{ whiteSpace: "nowrap" }}>
                              <button
                                class="btn btn-edit me-2 px-2"
                                type="button"
                              >
                                <Link
