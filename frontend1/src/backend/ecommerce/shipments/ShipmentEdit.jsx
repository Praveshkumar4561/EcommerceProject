...
function ShipmentEdit() {
  ...
  let [shipment1, setShipment1] = useState([]);
  ...
  return (
    <>
      ...
      >
        <div className="sidebar-ship mt-1">
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb ms-2 d-flex flex-wrap">
          ...
          <li className="breadcrumb-item fw-medium text-dark cart-cart">
            ECOMMERCE
          </li>
          <li className="breadcrumb-item fw-medium text-dark cart-cart">
            <Link to="/admin/ecommerce/shipments">SHIPMENTS</Link>
          </li>
          <li className="breadcrumb-item fw-medium text-dark cart-cart">
            EDIT SHIPPING
            {shipment1.map((data) => (
              <>
                <span className="ms-1">{data.order_number}</span>
              </>
            ))}
          </li>
        </ol>
      ...
      <div className="container-fluid">
        <div className="container">
          <div className="row ms-lg-5 ps-lg-3">
            {shipment1.map((data, key) => (
              <div className="col-12 col-lg-12 col-md-12 border rounded shipment-info py-4">
                <div
                  className="d-flex flex-row justify-content-between align-items-center"
                  key={key}
                >
                  <FontAwesomeIcon icon={faTruck} className="vertical-line" />
                  ...
                  <div className="name-truck vertical-line">
                    <Link
                      to={"/admin/ecommerce/orders"}
                      className="text-decoration-none name-truck"
                    >
                      {data.name}
                    </Link>
                  </div>
                  ...
                  <div
                    className="fw-bold vertical-line"
                ...
                <hr />
                <div className="text-center name-truck">
                  View Order:{" "}
                  <Link
                    className="name-truck text-decoration-none"
                    to="/admin/ecommerce/orders"
                  >
                    {data.order_number}
                  </Link>
          ...
          <div className="row gap-0 ms-lg-5 ps-lg-3 mt-lg-4 me-1 d-flex flex-row flex-lg-wrap flex-wrap flex-xl-nowrap">
            <div className="col-12 col-md-12 col-lg-8 border rounded py-2 text-start shipment-page">
              ...
              <div className="d-flex flex-column">
                <label htmlFor="">Additional shipment information</label>
                <input
                  type="text"
              ...
              <div className="d-flex flex-column mt-3">
                ...
                <input
                  type="text"
                  className="form-control mt-2 py-4 cart-cart"
                  placeholder="Ex:https://mydhl.express.dhl/us/en/tracking"
                />
              </div>

              <div className="d-flex flex-column mt-3">
                <label htmlFor="">Estimate Date Shipped</label>
                <input
                  type="date"
                  className="form-control mt-2 py-4 cart-cart"
                />
              ...
              <div className="d-flex mt-4 mb-3">
                <button className="btn btn-success py-4 rounded d-flex flex-row align-items-center cart-cart">
            ...
            <div className="col-12 col-sm-12 col-md-12 col-lg-4 gap-3 lh-lg mt-3 mt-lg-3 mt-xxl-0 mt-xl-0 shipment-page1">
              <div className="border rounded p-2 customer-page1 text-start">
                <h6 className="mt-2 fw-bold">Shipment information</h6>
                <hr />
                {shipment1.map((data, key) => (
                  <>
                    <div
                    ...
                    <div className="d-flex justify-content-between flex-row mb-3">
                      ...
                      <button className="btn btn-success rounded d-flex cart-cart">
                        Pending
                      </button>
                    </div>
                  </>
              ...
              <div className="border rounded p-3 customer-page1 lh-lg text-start mt-3">
                <h6 className="mt-0 fw-bold">Customer information</h6>
                <hr />
                {shipment1.map((data, key) => (
                  <>
                    <div className="d-flex flex-column" key={key}>
                      ...
                      <span style={{ color: "#206bc4" }}>
                        <FontAwesomeIcon icon={faPhone} className="me-1" />
                        {data.phone_number}
                      </span>
                      <span style={{ color: "#206bc4" }}>{data.email}</span>
