...
function ProductTags() {
  ...
  let searchbar = async () => {
    let response = await axios.get(
      `http://52.9.253.67:1600/searchtags/${search}`
    );
  ...
  let deletedata = async (id) => {
    await axios.delete(`http://52.9.253.67:1600/deletetags/${id}`, user);
    ...
    <>
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb ms-2">
          ...
          <li className="breadcrumb-item fw-medium text-dark">PRODUCT TAGS</li>
        </ol>
      </nav>
        ...
        <div class="card mt-3 testimonial table-price ms-3 ms-lg-0">
          <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
              ...
              <div className="mt-2 mt-sm-0 ms-sm-2 mt-lg-0 d-flex flex-row">
                <Link
                  to="/admin/ecommerce/product-tags/create"
                  ...
                  {Array.isArray(user) && user.length > 0 ? (
                    user.map((data, key) => (
                      <tr key={key}>
                        ...
                        <td>
                          <Link
                            to={`/admin/ecommerce/product-tags/edit/${data.id}`}
                          >
                            {data.name}
                          </Link>
                        </td>
