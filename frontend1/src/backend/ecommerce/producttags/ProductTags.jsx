...
function ProductTags() {
  ...
  let searchbar = async () => {
    let response = await axios.get(
      `http://147.93.45.171:1600/searchtags/${search}`
    );
    setUser(response.data);
  };

  let alldata = async () => {
    let response = await axios.get("http://147.93.45.171:1600/producttagdata");
    setUser(response.data);
  };
  ...
  let deletedata = async (id) => {
    await axios.delete(`http://147.93.45.171:1600/deletetags/${id}`, user);
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Product tags | RxLYTE</title>
        ...
        <meta
          ...
          content="Copyright 2025 © RxLYTE. All rights reserved."
        />
        <meta property="og:title" content="Product tags | RxLYTE" />
          ...
          <div className="card-body">
            <div className="d-flex justify-content-between mb-3">
              ...
              <div className="mt-2 mt-sm-0 ms-sm-2 mt-lg-0 d-flex flex-row">
                ...
                <button
                  className="btn btn-reload bulk d-flex flex-row align-items-center border"
                  type="button"
