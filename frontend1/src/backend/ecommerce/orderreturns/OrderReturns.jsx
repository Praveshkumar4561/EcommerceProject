...
function OrderReturns() {
  ...
  let searchbar = async () => {
    let response = await axios.get(
      `http://localhost:1600/contactsearch/${search}`
    );
    setUser(response.data);
  };

  let deletedata = async (id) => {
    await axios.delete(`http://localhost:1600/deletecontact/${id}`, user);
  ...
  const handleDownload = async () => {
    try {
      const response = await axios.get(
        "http://localhost:1600/export-returnsorder",
        {
          responseType: "blob",
        }
      );
    ...
    <>
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb ms-2">
          ...
          <li className="breadcrumb-item fw-medium text-dark">ORDER RETURNS</li>
        </ol>
      </nav>
            ...
            <div class="d-flex justify-content-between mb-3">
              <div class="d-flex flex-row">
                <div class="btn-group me-2">
                  <button
                    aria-expanded="false"
                    class="btn btn-secondary dropdown-toggle d-flex flex-row align-items-center py-4 btn-announ"
                ...
                <button
                  class="btn btn-secondary me-2 py-4 d-flex btn-announ mt-lg-0"
                  type="button"
                >
                  Filters
                </button>
                <input
                  class="form-control py-4 rounded-2 mt-lg-0"
                  placeholder="Search..."
                  type="text"
                  name="search"
                  value={search}
              ...
              <div className="d-flex flex-row ms-2">
                <button
                  class="btn btn-create me-2 mt-2 mt-sm-0 mt-lg-2 d-flex flex-row align-items-center"
                  type="button"
                ...
                <button
                  class="btn btn-reload mt-2 mt-lg-2 mt-sm-0 border d-flex flex-row align-items-center"
                  type="button"
                >
