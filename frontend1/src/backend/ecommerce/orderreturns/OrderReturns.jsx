...
function OrderReturns() {
  ...
  const handleDownload = async () => {
    try {
      const response = await axios.get(
        "https://demo.webriefly.com/api/export-returnsorder",
        {
          responseType: "blob",
        }
      );
    ...
    <>
      ...
      >
        ...
        >
          ...
          <input
            type="search"
            className="text-light py-4 search-welcome form-control d-none d-lg-block border border-secondary cart-car"
            placeholder="Search"
            value={query}
          ...
          {isOpen && (
            <div className="search-results-container" ref={resultsRef}>
              {results.length > 0 ? (
                <ul className="search-results cart-cart1 text-dark">
      ...
      <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4 table-announce w-auto d-flex justify-content-center align-items-center cart-cart">
        <div className="card mt-3 testimonial table-price">
