...
function ContactPage() {
  ...
  let alldata = async () => {
    let response = await axios.get("http://localhost:1600/allcontact");
    setUser(response.data);
  };
    ...
    <>
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb ms-2">
          ...
          <li className="breadcrumb-item fw-medium text-dark">CONTACT</li>
        </ol>
      </nav>
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
              ...
              <div className="mt-2 ms-sm-2 mt-lg-0 d-flex flex-row">
                ...
                <button
                  class="btn btn-reload border d-flex flex-row align-items-center"
                  type="button"
                >
