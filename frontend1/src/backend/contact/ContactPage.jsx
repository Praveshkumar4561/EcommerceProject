    ...
    <>
      <Helmet>
        ...
        <meta
          ...
          content="Copyright 2025 © RxLYTE. All rights reserved."
        />
        <meta property="og:title" content="Contact | RxLYTE" />
      ...
      <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4 table-announce w-auto d-flex  justify-content-center align-items-center">
        <div className="card mt-3 testimonial table-price ms-4 ms-lg-0 cart-cart">
          <div className="card-body">
            <div className="d-flex justify-content-between mb-3">
              <div className="d-flex flex-row w-100">
                ...
                <input
                  className="form-control py-4 mt-2 mt-lg-0 rounded-2 w-25 ms-0 border cart-cart"
                  placeholder="Search..."
                  type="search"
                  name="search"
                  value={search}
              ...
              <div className="mt-2 ms-sm-2 mt-lg-0 d-flex flex-row">
                ...
                <button
                  className="btn btn-reload border d-flex flex-row align-items-center cart-cart"
                  type="button"
                >
