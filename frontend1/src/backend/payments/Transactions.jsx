...
function Transactions() {
  ...
  let paymentdata = async () => {
    const response = await axios.get("http://89.116.170.231:1600/paymentdata");
    ...
    <>
      <Helmet>
        ...
        <meta
          ...
          content="Copyright 2025 © RxLYTE. All rights reserved."
        />
        <meta property="og:title" content="Payments | RxLYTE" />
      ...
      >
        <div className="sidebar-news mt-1 h-auto">
          ...
          <div className="card-body">
            <div className="d-flex justify-content-between mb-3">
              <div className="d-flex flex-row w-100">
                ...
                <input
                  className="form-control py-4 rounded-2 bulk mt-0 mt-lg-0 mt-2 w-25 ms-0 border"
                  placeholder="Search..."
                  type="search"
                  name="search"
                  value={search}
