...
function TransactionsEdit() {
  ...
  return (
    <>
      ...
      >
        <div className="sidebar-news mt-1">
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb ms-2 cart-cart d-flex flex-wrap flex-lg-nowrap">
          ...
          <li className="breadcrumb-item fw-medium text-dark">TRANSATIONS</li>
        </ol>
      </nav>
            ...
            <div className="col-12 col-lg-8 border rounded customer-page review-public2">
              <div className="d-flex flex-column gap-2 name-form text-start flex-wrap flex-md-nowrap flex-lg-nowrap flex-sm-nowrap">
                <div className="d-flex flex-row justify-content-between w-100 flex-nowrap">
                  ...
                  <div className="d-flex justify-content-end gap-2 align-items-lg-center mt-2 flex-lg-nowrap flex-row flex-wrap">
                    <button className="btn btn-body border d-flex flex-row align-items-center py-4 cart-cart">
              ...
              <div className="d-flex justify-content-between w-100 flex-wrap lh-lg mt-3">
                <div className="d-flex flex-column">
                  <span className="fw-medium">CHARGE ID</span>
                  <span>aaa</span>
                </div>
                <div className="d-flex flex-column">
                  <h classNamee="fw-bold">PAYER NAME</h>
                  <span>aaa</span>
                </div>
                <div className="d-flex flex-column">
              ...
              <div className="d-flex justify-content-between w-100 flex-wrap lh-lg mt-lg-3">
                ...
                <div className="d-flex flex-column text-center">
                  <span className="fw-medium">PAYMENT CHANNEL</span>
                  <span>aaa</span>
                </div>
                <div className="d-flex flex-column">
