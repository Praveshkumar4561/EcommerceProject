  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://demo.webriefly.com/api/adminregister",
        payload
      );
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Create a new user | RxLYTE</title>
      ...
      <div className="container-fluid">
        <div className="container">
          <div className="row d-flex flex-row flex-xxl-nowrap flex-xl-nowrap gap-3 w-100 ms-lg-1 ms-0 cart-cart">
            <div className="col-12 col-lg-8 border rounded customer-page">
              <form>
                ...
                <div className="mb-3 position-relative text-start mt-2 mb-4">
                  <label>
