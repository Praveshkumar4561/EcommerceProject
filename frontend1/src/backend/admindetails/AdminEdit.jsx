...
function AdminEdit() {
  ...
  let { first_name, last_name, username, email } = user;
    ...
    const editdata = async () => {
      try {
        const { data } = await axios.get(
          `http://89.116.170.231:1600/adminsomedata/${id}`
        );
  ...
  const validateForm = () => {
    ...
    if (user.password) {
      ...
      if (!passwordRegex.test(user.password)) {
        newErrors.password =
          "Password must be at least 6 characters and include letters, numbers, and one of: ! @ # $ % ^ & *";
      }
    }
    if (
      user.password &&
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`http://89.116.170.231:1600/adminupdate/${id}`, payload);
      ...
      if (
        ...
        toast.error("You entered wrong current password", {
  ...
  return (
    <>
      <Helmet>
        ...
        <title>
          {user.first_name} {user.last_name} | RxLYTE
        </title>
        ...
        <meta
          ...
          content="Copyright 2025 © RxLYTE. All rights reserved."
        />
        <meta property="og:title" content="Create a customer | RxLYTE" />
      ...
      <nav className="breadcrumb-container text-center">
        <ol className="breadcrumb d-flex flex-lg-nowrap flex-wrap">
          <li className="breadcrumb-item fw-normal">
            <Link to="/admin/welcome">DASHBOARD</Link>
          </li>
          <li className="breadcrumb-item fw-normal text-dark">
      ...
      <div className="container-fluid">
        <div className="container">
          <div className="row d-flex flex-row flex-xxl-nowrap flex-xl-nowrap gap-3 w-100 ms-lg-1 ms-0 cart-cart">
            <div className="col-12 col-lg-8 border rounded customer-page text-start">
              <form>
                <div className="d-flex flex-row gap-2 name-form text-start flex-wrap flex-md-nowrap flex-lg-nowrap flex-sm-nowrap">
                  <div className="d-flex flex-column mb-3 mt-3 name-form1">
                    <label htmlFor="">
                      First Name <span className="fw-bold text-danger">*</span>
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="d-flex flex-column mb-3 mt-lg-3 mt-md-3 mt-sm-3 name-form1">
                    <label htmlFor="">
                      Last Name <span className="fw-bold text-danger">*</span>
                    </label>
                    <input
                      type="text"
                      className="form-control mt-2 py-4"
                ...
                <div className="d-flex flex-row gap-2 name-form text-start flex-wrap flex-lg-nowrap flex-md-nowrap flex-sm-nowrap">
                  <div className="d-flex flex-column mb-3 mt-lg-0 name-form1">
                    <label htmlFor="">
                      Username <span className="fw-bold text-danger">*</span>
                    </label>
                    <input
                      type="text"
                      className="form-control mt-2 py-4"
                ...
                <div className="form-check form-switch text-start mb-3">
                  ...
                  />
                  <label htmlFor="has-action" className="form-check-label ms-2">
                    Change password?
                  </label>
                </div>
                ...
                {showPasswordFields && (
                  <>
                    <div className="mb-3 position-relative text-start">
                      ...
                      <input
                        type="password"
                        className="form-control py-4 pe-5 mt-2"
                    ...
                    <div className="d-flex flex-row gap-2 name-form text-start flex-wrap flex-lg-nowrap flex-md-nowrap flex-sm-nowrap">
                      <div className="d-flex flex-column mb-lg-4 mb-2 mt-lg-1 name-form1 position-relative">
                        <label>
                          New Password <span className="text-danger">*</span>
                        </label>
                        <input
                          className="form-control mt-2 py-4 pe-5"
                        ...
                        <FontAwesomeIcon
                          ...
                          className="position-absolute translate-middle-y end-0 me-1 pe-2"
                          onClick={() => setPasswordVisible((v) => !v)}
                          style={{ cursor: "pointer", marginTop: "56px" }}
                        />
                        {errors.password && (
                          <small className="text-danger text-start">
                            New {errors.password}
                      ...
                      <div className="d-flex flex-column mb-3 mt-lg-1 name-form1 position-relative">
                        <label>
            ...
            <div className="col-12 col-sm-12 col-md-12 col-lg-4 d-flex flex-column gap-3 customer-page1 text-start">
              ...
              <div className="border rounded p-2 customer-page1 mb-3">
                <h4 className="mt-0 text-start">Role</h4>
