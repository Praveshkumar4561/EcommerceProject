...
export default function Account() {
  ...
  const pageUrl = `http://srv689968.hstgr.cloud/themes/static/${themeFolder}/account.html`;
  const themeBaseUrl = `http://srv689968.hstgr.cloud/themes/static/${themeFolder}/`;
