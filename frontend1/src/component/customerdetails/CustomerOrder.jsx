            ...
            <div className="col-12 col-sm-12 col-md-12 col-lg-6 bg-body shadow-lg customer-dashboard1 text-start rounded-0 mb-2 ms-lg-2 ms-sm-2 border d-flex flex-column align-items-center py-5 overflow-hidden">
              {view.length === 0 ? (
                <>
                  ...
                  <button className="btn btn-success d-flex mt-2 py-4 button-orders rounded-0">
                    <Link
                        ...
                        customer.map((data, key) => (
                          <tr key={key}>
                            ...
                            <td style={{ fontFamily: "verdana" }}>
                              ${data.total} for {data.items_count || count}{" "}
                              item(s).
                            </td>
                            ...
                            <td>
                              <Link
                                ...
                                target="_blank"
                              >
                                <button className="btn btn-success d-flex rounded-0 cart-cart">
                                  View
                                </button>
                              </Link>
                            </td>
