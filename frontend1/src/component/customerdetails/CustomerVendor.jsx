...
function CustomerVendor() {
  ...
  useEffect(() => {
    let orderdata = async () => {
      let response = await axios.get("https://demo.webriefly.com/api/checkoutdata");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("https://demo.webriefly.com/api/vendorshop", user);
  ...
  let vendor_data = async () => {
    let response = await axios.get("https://demo.webriefly.com/api/vendordata", user);
