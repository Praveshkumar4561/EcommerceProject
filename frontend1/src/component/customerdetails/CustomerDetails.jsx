  ...
  return (
    <>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="http://srv689968.hstgr.cloud/user/dashboard"
        />
      </Helmet>
              ...
              {detail ? (
                <div key={detail.id}>
                  <div className="d-flex flex-row">
                    {detail.gender === "male" || !detail.gender ? (
                  ...
                  <div className="d-flex gap-2 mb-4 border rounded py-3 order-back d-flex justify-content-between">
                    <div className="ms-3 recent text-dark">
                      <img src={Tick} alt="Tick" className="me-1" />
                ...
                <div className="no-details">No user details found</div>
              )}
            </div>
          </div>
        </div>
