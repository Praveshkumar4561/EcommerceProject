...
function CustomerAddress() {
  ...
  const alldata = async () => {
    try {
      let response = await axios.get(
        "http://54.183.54.164:1600/userdashboarddata"
      );
  ...
  let removedata = async (id) => {
    await axios.delete(`http://54.183.54.164:1600/deleteuser/${id}`, user);
      ...
      <div className="container-fluid">
        <div className="container">
          <div className="row gap-1 d-flex flex-wrap justify-content-start justify-content-lg-start ms-lg-0 mt-3">
            ...
            <div className="col-12 col-sm-12 col-md-12 col-lg-6 bg-body shadow-lg customer-dashboard1 text-start rounded-0 mb-2 ms-lg-2 ms-sm-2 border d-flex flex-column align-items-start py-5 overflow-hidden">
              {user.length === 0 ? (
                <>
                  ...
                  <span className="text-center mt-2 fs-6 button-orders">
              ...
              <button className="btn btn-success d-flex mt-4 py-4 button-orders rounded-0">
                <Link
