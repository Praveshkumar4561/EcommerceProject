...
import ThemeHomePage from "./theme_component/homepage/ThemeHomePage.jsx";
import ThemeShop from "./theme_component/shoppage/ThemeShop.jsx";
import ThemeContact from "./theme_component/contactpage/ThemeContact.jsx";
import ThemeFaqs from "./theme_component/faqpage/ThemeFaqs.jsx";
import ThemeSignUp from "./theme_component/themesignup/ThemeSignUp.jsx";
import ThemeLogin from "./theme_component/themesignup/ThemeLogin.jsx";
import ThemeError from "./theme_component/errorpage/ThemeError.jsx";
import ThemeCart from "./theme_component/cartpage/ThemeCart.jsx";
import ThemeWishlist from "./theme_component/wishlistpage/ThemeWishlist.jsx";
import ThemeAbout from "./theme_component/aboutpage/ThemeAbout.jsx";
import ThemeBlogs from "./theme_component/blogpage/ThemeBlogs.jsx";
import ThemeBlogLists from "./theme_component/bloglists/ThemeBlogLists.jsx";
import ThemeBlogDetails from "./theme_component/blogdetails/ThemeBlogDetails.jsx";
import ThemeShopGrid from "./theme_component/themeshopgrid/ThemeShopGrid.jsx";
import ThemeShopDetails from "./theme_component/shopdetails/ThemeShopDetails.jsx";
import ThemeCheckout from "./theme_component/themecheckout/ThemeCheckout.jsx";
            ...
            createRoutesFromElements(
              <>
                <Route path="/" element={<User />}>
                  ...
                  <Route path="theme">
                    <Route index element={<ThemeHomePage />} />
                    <Route path="shop" element={<ThemeShop />} />
                    <Route path="contact" element={<ThemeContact />} />
                    <Route path="faqs" element={<ThemeFaqs />} />
                    <Route path="register" element={<ThemeSignUp />} />
                    <Route path="login" element={<ThemeLogin />} />
                    <Route path="cart" element={<ThemeCart />} />
                    <Route path="wishlist" element={<ThemeWishlist />} />
                    <Route path="about" element={<ThemeAbout />} />
                    <Route path="blog-grid" element={<ThemeBlogs />} />
                    <Route path="blog-lists" element={<ThemeBlogLists />} />
                    <Route
                      path="blog-details/:id"
                      element={<ThemeBlogDetails />}
                    />
                    <Route path="shop-grid" element={<ThemeShopGrid />} />
                    <Route path="shop-details" element={<ThemeShopDetails />} />
                    <Route path="checkout" element={<ThemeCheckout />} />
                    <Route path="error" element={<ThemeError />} />
                  </Route>
