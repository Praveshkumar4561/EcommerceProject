...
function ThemeSignUp() {
  ...
  const { first_name, email, password } = registerUser;

  const handleRegisterSubmit = async (e) => {
    e.preventDefault();
    if (!strongPasswordRegex.test(password)) {
      return toast.error(
        "Password must be at least 8 characters long and include uppercase, lowercase, a number and a special symbol.",
        {
    ...
    <>
      ...
      <section className="shop-header">
        ...
        <div className="shop-header__inner">
          <h1 className="shop-header__title">Account Register</h1>
      ...
      <div className="container cart-cart d-flex justify-content-center align-items-center mt-5">
        <div className="col-12 col-md-8 col-lg-6 login-wrap p-4 rounded account-or">
          <h3 className="text-center mb-2 mt-4">Create Your Account</h3>
          ...
          >
            ...
            <div className="mb-4 position-relative">
              ...
              <input
                ...
                title="Must be ≥8 characters, include uppercase, lowercase, number & special character."
              />
              <FontAwesomeIcon
            ...
            <div className="form-check mb-2">
              ...
              <label className="form-check-label" htmlFor="termsCheck">
                I accept the{" "}
                <Link to="#" className="color-roiser text-decoration-none">
                  Terms
                </Link>{" "}
                /{" "}
                <Link to="#" className="color-roiser text-decoration-none">
          ...
          <p className="text-start">
            ...
            <Link
              to="/theme/login"
              className="color-roiser text-decoration-none"
            >
              Log in
            </Link>
          </p>
