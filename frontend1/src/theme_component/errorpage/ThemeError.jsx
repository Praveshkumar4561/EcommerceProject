    ...
    <>
      ...
      <section className="shop-header">
        ...
        <div className="shop-header__inner">
          <h1 className="shop-header__title">404</h1>
      ...
      <div className="container text-center">
        <div className="row">
          <div className="col-12 d-flex flex-column justify-content-center align-items-center mt-0">
            ...
            <h2 className="opps cart-cart">Page Not Found</h2>
            <p className="sorry-para mt-0 text-dark text-center cart-cart mb-2 theme-look">
            ...
            <Link
              to="/theme"
              className="btn theme-error d-flex py-4 cart-cart1 rounded-1 text-decoration-none d-flex align-items-center justify-content-center flex-row flex-nowrap gap-2"
            >
              Back to Home
