    ...
    <>
      ...
      <section className="shop-header">
        ...
        <div className="shop-header__inner">
          <h1 className="shop-header__title">Wishlist</h1>
      ...
      <div className="row w-100 d-flex justify-content-center align-items-center cart-cart">
        <div className="col-12 wishlist-shown">
          <div className="table-responsive p-3 rounded">
            <table className="table align-middle text-center border mb-0">
              <thead>
                <tr>
                  <th className="wishlist-error"></th>
                  <th className="text-start wishlist-error">Product Name</th>
                  <th className="wishlist-error">Price</th>
                  <th className="wishlist-error">Stock Status</th>
                  <th className="wishlist-error"></th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="wishlist-error">
                    <span className="text-danger fs-4" role="button">
                      ×
                    </span>
                  </td>

                  <td className="text-start d-flex align-items-center gap-3 flex-row flex-nowrap wishlist-error">
                    <div
                      style={{
                        width: "81px",
                        height: "80px",
                    ...
                    <div className="d-flex flex-column">
                      ...
                      <strong>Power Guard Fortress</strong>
                    </div>
                  </td>

                  <td className="fw-bold wishlist-error">$550.00</td>
                  <td className="wishlist-error">Out of stock</td>
                  <td className="wishlist-error">
                    <button className="btn btn-message btn-added d-flex ms-auto me-0 justify-content-center align-items-center me-lg-5 me-0">
                      Add To Cart
                    </button>
                  </td>
                </tr>
