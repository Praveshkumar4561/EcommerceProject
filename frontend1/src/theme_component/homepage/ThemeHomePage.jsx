    ...
    <>
      ...
      <header className="site-header ">
        ...
        <div className="d-flex justify-content-center bg-light me-md-0">
          <nav
            className={`site-header__nav rounded${fixed ? " is-fixed" : ""}`}
          >
        ...
        >
          ...
          >
            ...
            <ul className="mt-2 sidebar-women cart-cart1">
      ...
      <div className="text-start cart-cart1 ms-2 me-2">
        temporibus aut commodi, voluptate vitae asperiores eum repellat.
        Molestiae et repellendus illum, accusamus aperiam itaque suscipit? Non
        eaque exercitationem quod modi iusto? Veniam, debitis minus reiciendis
        voluptatum aspernatur veritatis temporibus illo nesciunt ipsum impedit,
        laboriosam cupiditate nulla praesentium. Lorem ipsum dolor sit, amet
        consectetur adipisicing elit. Rerum inventore animi delectus quod
        voluptatum? Dolorum libero animi, perspiciatis nostrum, aperiam illo,
        laborum nihil ad impedit delectus quasi debitis. Saepe nam tempora
        tempore! Repellat ea nobis eos, maxime expedita nostrum doloribus
        corrupti at non perspiciatis excepturi aspernatur ab, explicabo qui aut
        dolorum incidunt facilis odio soluta! Esse accusantium aspernatur cumque
        nobis veritatis. Nihil veritatis omnis libero consequuntur sed itaque,
        ex exercitationem sit! Qui, eius perspiciatis debitis blanditiis dolores
        eos aliquid ipsa accusantium ex quam magni corporis voluptatum, nostrum
        ipsam veniam incidunt! Aperiam reiciendis necessitatibus in, incidunt
        quae commodi veritatis deleniti suscipit.
      </div>
