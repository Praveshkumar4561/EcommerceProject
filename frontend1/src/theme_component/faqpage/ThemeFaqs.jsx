    ...
    <>
      ...
      <section className="shop-header">
        ...
        <div className="shop-header__inner">
          <h1 className="shop-header__title">Frequently asked questions</h1>
      ...
      <div className="container d-flex justify-content-start justify-content-lg-center align-items-center ms-lg-0 cart-cart1">
        <div className="row theme-contact ms-1 ms-lg-0 medicine-text d-flex flex-md-wrap flex-lg-row flex-lg-nowrap bg-body">
          <div className="col-12 col-lg-8 ps-0 ps-lg-0 ps-md-3 me-0 ms-0 medicine-usa">
            <div className="faq-container text-start">
              {Array.isArray(faqs) && faqs.length > 0 ? (
                faqs.map((item, index) => (
                  ...
                  >
                    <div
                      className="faq-question d-flex justify-content-between align-items-center bg-body flex-row flex-nowrap"
                      onClick={() => toggle(index)}
                    >
                      <h5 className="mb-0 question-five">{item.question}</h5>
                      <FontAwesomeIcon
                        icon={faAngleDown}
                        className="faq-icon"
                      />
                    ...
                    {openIndex === index && (
                      <div className="faq-answer bg-body">
                        <div
          ...
          <div className="col-12 col-lg-4 ms-0 ms-lg-0 p-4 mb-5 d-flex flex-column mt-1 mt-md-0 ms-md-3 text-start discount-sub me-0 me-lg-0 ms-lg-3">
            <form method="post" className="w-100" onSubmit={handleSubmit}>
              <div className="d-flex flex-column">
                ...
                <input
                  type="email"
                  className="form-control py-4 mt-4 cart-cart"
                ...
                />
                <textarea
                  className="form-control mt-4 cart-cart"
                  placeholder="Message"
                  style={{ height: "130px" }}
                  name="message"
                  value={message}
                ...
                <div className="mt-4">
                  <button
                    className="btn btn-message d-flex cart-cart w-100"
                    type="submit"
                  >
                    Submit Now
                  </button>
