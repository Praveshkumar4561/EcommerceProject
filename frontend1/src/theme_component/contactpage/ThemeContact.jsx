...
function ThemeContact() {
  ...
  const { name, email, subject, content } = user;
  ...
  const handleSubmit = async (e) => {
    ...
    if (email.trim()) {
      const re = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
      if (!re.test(email)) formErrors.email = "Enter a valid email address";
    }
    if (!subject.trim()) formErrors.subject = "Subject is required";
    if (!content.trim()) formErrors.content = "Message is required";
    ...
    try {
      ...
      console.error(err);
      toast.error("Contact details were not submitted", {
        position: "bottom-right",
        autoClose: 2000,
      });
    }
    ...
    <>
      ...
      <section className="shop-header">
        ...
        <div className="shop-header__inner">
          <h1 className="shop-header__title">Contact</h1>
      ...
      <div className="container d-flex justify-content-center align-items-center cart-cart1">
        <div className="row theme-contact d-flex flex-md-column flex-lg-row">
          <div className="col d-flex flex-column ps-0 ps-lg-3 ps-md-3">
            <h3 className="ms-2 mt-5 mb-3 fw-bold">Get In Touch</h3>
            <form
              method="post"
              className="me-1 ms-2 me-lg-0"
              onSubmit={handleSubmit}
            >
              <div className="d-flex flex-row flex-wrap flex-sm-nowrap flex-md-nowrap flex-lg-nowrap gap-3">
              ...
              <div className="mt-4 mb-4">
                <button
                  className="btn btn-message d-flex cart-cart"
                  type="submit"
                >
                  Submit Message
                </button>
          ...
          <div className="col-12 touch-contact touch-contact1 line-store ms-1 me-1 p-4 mb-5 d-flex flex-column mt-5 text-start me-1">
            <div className="image-sit">
              <img src={contact} alt="Contact us" className="img-fluid" />
            </div>

            <h3 className="fw-bold mt-3 cloth-lap">Clothing Store</h3>
            ...
            <h3 className="fw-bold mt-3 cloth-lap">Opening Hours</h3>
      ...
      <div className="container d-flex justify-content-center ms-2 align-items-center cart-cart1 mt-5">
        <div className="row theme-contact d-flex flex-md-column flex-lg-row me-1">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d113911.07561696472!2d80.86011185183632!3d26.848821286788176!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399bfd991f32b16b%3A0x93ccba8909978be7!2sLucknow%2C%20Uttar%20Pradesh!5e0!3m2!1sen!2sin!4v1747481328386!5m2!1sen!2sin"
            allowFullScreen
            loading="lazy"
            referrerPolicy="no-referrer-when-downgrade"
            className="theme-location m-0 p-0"
          ></iframe>
        </div>
      </div>
