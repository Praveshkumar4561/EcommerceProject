    ...
    <>
      ...
      <section className="shop-header">
        ...
        <div className="shop-header__inner">
          <h1 className="shop-header__title">Blog Grid</h1>
          ...
          {Array.isArray(user) && user.length > 0 ? (
            user.map((data, key) => (
              <div
                ...
                mb-3 shadow-sm border blogs-theme1
                d-flex flex-column p-0 blog-thumb"
              >
                ...
                <div className="p-4 d-flex flex-column flex-grow-1">
                  <div className="d-flex flex-row flex-nowrap align-items-center gap-2 mb-2">
                    <FontAwesomeIcon
                      icon={faCalendarDays}
                      className="color-roiser fw-bold"
                    />
                    <span className="raed-flow">3 COMMENT</span>

                    <div className="d-flex flex-row flex-nowrap align-items-center gap-2 ms-3">
                      <FontAwesomeIcon
                        icon={faTag}
                        className="color-roiser pt-1"
                      />
                      <span className="raed-flow">OIL CHANGE</span>
                    </div>
                  </div>

                  <div className="d-flex flex-column">
                    <h3 className="fw-bold blog-thumb1 mb-3 text-start mt-1">
                      {data.name.split(" ").slice(0, 10).join(" ")}
                    </h3>

                    <hr className="w-100 mx-0 mt-auto" />

                    <div className="roiser-gap mt-3 d-flex flex-row flex-nowrap align-items-center gap-2 read-more">
                      <Link
                        to={`/theme/blog-details/${data.id}`}
                        aria-label={`Read more about ${data.name}`}
                        className="text-decoration-none"
                      >
                        <span className="text-dark roiser-gap1">Read More</span>
                        <FontAwesomeIcon
                          icon={faArrowRight}
                          className="read-more-icon pt-1 ms-1 text-dark roiser-gap1"
                        />
                      </Link>
                    </div>
                  </div>
            ...
            <div className="col-12 text-center cart-cart">
