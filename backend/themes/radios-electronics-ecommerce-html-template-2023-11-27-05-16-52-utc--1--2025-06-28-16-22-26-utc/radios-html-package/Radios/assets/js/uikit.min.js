...
!(function (t, e) {
  ...
  function nt(t, e, n) {
    if (I(e)) for (var i in e) nt(t, i, e[i]);
    else {
      if (P(n)) return (t = j(t)) && t.getAttribute(e);
      W(t).forEach(function (t) {
        $(n) && (n = n.call(t, nt(t, e))),
          null === n ? rt(t, e) : t.setAttribute(e, n);
      });
    }
  }
  function it(t, e) {
  ...
  function se(s, a) {
    return new ee(function (t, e) {
      ...
      Wt(i, "load", function () {
        ...
        304 === i.status
          ? t(i)
          : e(U(Error(i.statusText), { xhr: i, status: i.status }));
      }),
        Wt(i, "error", function () {
          return e(U(Error("Network Error"), { xhr: i }));
        }),
        Wt(i, "timeout", function () {
          return e(U(Error("Network Timeout"), { xhr: i }));
        }),
        i.send(n.data);
    });
  }
  ...
  function he(t) {
    if ("loading" === document.readyState)
      var e = Wt(document, "DOMContentLoaded", function () {
        e(), t();
      });
    else t();
  }
  ...
  function de(t, e) {
    return (
      (t = Se(t)), P(e) ? t.innerHTML : fe(t.hasChildNodes() ? le(t) : t, e)
    );
  }
  function fe(e, t) {
    return (
        ...
        W(t).forEach(function (t) {
          for (var e = t.classList, n = 0; n < i.length; n++)
            Be.Force
              ...
              : e[(P(r) ? !e.contains(i[n]) : r) ? "add" : "remove"](i[n]);
        });
    }
  }
  function De(t, n, i) {
    ...
    ["left", "top"].forEach(function (t) {
      if (t in i) {
        ...
        He(
          n,
          t,
          i[t] - r[t] + F("absolute" === o && "auto" === e ? rn(n)[t] : e)
        );
      }
    });
  }
  function nn(t) {
    ...
    Pt(t) ||
      ...
      ((e = nt(t, "style")),
      (n = nt(t, "hidden")),
      nt(t, { style: (e || "") + ";display:block !important;", hidden: null }));
    var h = t.getBoundingClientRect();
    return (
      P(e) || nt(t, { style: e, hidden: n }),
      {
        height: h.height,
        width: h.width,
        top: h.top + r,
  ...
  function rn(i) {
    var r =
      ...
      t = ["top", "left"].reduce(function (t, e) {
        ...
        return (
          (t[e] -=
            o[e] + F(He(i, "margin" + n)) + F(He(r, "border" + n + "Width"))),
          t
        );
      }, en(i));
  ...
  function an(i) {
    ...
    return function (t, e) {
      if (((t = j(t)), P(e))) {
        ...
        return (
          (e = "auto" === (e = He(t, i)) ? t["offset" + r] : F(e) || 0) -
          hn(i, t)
        );
      }
    ...
    return (
      ...
      He(n, "boxSizing") === e
        ? Qe[t]
            ...
            .reduce(function (t, e) {
              return (
                t + F(He(n, "padding" + e)) + F(He(n, "border" + e + "Width"))
              );
            }, 0)
        : 0
    );
  ...
  function fn(t, e, n) {
    ...
    return Q(r, o) || tt({ x: r.left, y: r.top }, o);
  }
  function pn(t, e) {
  ...
  function $n(t) {
    void 0 === t && (t = !1),
      xn.scheduled ||
        ((xn.scheduled = !0),
        t ? ee.resolve().then(kn) : requestAnimationFrame(kn));
  }
  function In(t) {
  ...
  (Cn.events =
    ...
    (Cn.update = function (t, e) {
      return K(_n(t, $(e) ? { read: e } : e), "order");
    }),
    ...
    ((Vn = Hn).prototype._init = function (t) {
      ((t = t || {}).data = (function (t, e) {
        ...
        if (
          ...
          for (var o in n)
            P(n[o]) ? delete n[o] : (n[o] = r[o] ? Qn(r[o], n[o]) : n[o]);
        return n;
      ...
      (i.prototype.$mount = function (t) {
        ...
        t[r] || (t[r] = {}),
          t[r][e] ||
            ...
            jt(t, document) && this._callConnected());
      }),
        ...
        (i.prototype.$destroy = function (t) {
          ...
          n && this._callDisconnected(),
            ...
            n &&
              n[r] &&
              (delete n[r][i], B(n[r]) || delete n[r], t && ve(this.$el));
        }),
      ...
      methods: {
                ...
                ? (function (t) {
                    ...
                    return function (t, e) {
                      var n = Ue.inProgress(t),
                        i = t.hasChildNodes
                          ? F(He(t.firstElementChild, "marginTop")) +
                      ...
                      return (
                        ...
                        (e
                          ? Ue.start(
                              t,
                              U({}, h, { overflow: "hidden", height: o }),
                              Math.round(a * (1 - r / o)),
                              u
                            )
                          : Ue.start(t, c, Math.round(a * (r / o)), u).then(
                              function () {
                                return l(t, !1);
                              }
                            )
        ...
        _toggle: function (t, e) {
          ...
          t &&
            ((e = Boolean(e)),
            this.cls
              ? (n = b(this.cls, " ") || e !== Me(t, this.cls)) &&
                Oe(t, this.cls, b(this.cls, " ") ? void 0 : e)
              : (n = e === it(t, "hidden")) && nt(t, "hidden", e ? null : ""),
  ...
  var ni = {
      ...
      events: [
        {
          ...
          handler: function (t) {
            t.preventDefault(),
              this.toggle(
                ce(
                  Te(this.targets + " " + this.$props.toggle, this.$el),
                  t.current
                )
              );
          },
      ...
      update: function () {
        ...
        var t =
          !this.collapsible && !Me(this.items, this.clsOpen) && this.items[0];
        t && this.toggle(t, !1);
      },
      methods: {
        toggle: function (r, o) {
            ...
            [r]
              ...
              .forEach(function (t) {
                ...
                if (n || !e || s.collapsible || !(a.length < 2)) {
                  ...
                  t._wrapper ||
                    ((t._wrapper = we(i, "<div>")),
                    nt(t._wrapper, "hidden", n ? "" : null)),
                    s._toggle(i, !0),
                    s.toggleElement(t._wrapper, n, o).then(function () {
                      Me(t, s.clsOpen) === n &&
                        (n || s._toggle(i, !1), (t._wrapper = null), ye(i));
                    });
                }
              });
        },
    ...
    ii = {
      ...
      data: {
        ...
        duration: 150,
        hideProps: U({ opacity: 0 }, ei.data.hideProps),
      },
      events: [
        {
          name: "click",
  ...
  function ri(r) {
    he(function () {
      var n;
      r.update(),
        Wt(window, "load resize", function () {
          ...
          function (t) {
            if ((e && e(), Zt(t))) {
              ...
              (e = Rt(document, ft + " " + gt, function (t) {
                ...
                "touchstart" === lt &&
                  (He(document.body, "cursor", "pointer"),
                  Rt(document, ft + " " + gt, function () {
                    return setTimeout(function () {
  ...
  var oi,
    ...
    ci = {
      ...
      connected: function () {
        ...
        (this.toggle =
          t &&
          this.$create("toggle", vt(t, this.$el), {
            target: this.$el,
            mode: this.mode,
          })),
          ...
          handler: function (t) {
            Zt(t) ||
              (oi &&
                oi !== this &&
                oi.toggle &&
                b(oi.toggle.mode, "hover") &&
                !jt(t.target, oi.toggle.$el) &&
                !tt({ x: t.pageX, y: t.pageY }, en(oi.$el)) &&
                oi.hide(!1),
              t.preventDefault(),
        ...
        },
        {
          ...
          handler: function () {
            ...
            var t = ui(document, "click", function (t) {
              ...
              e ||
                jt(n, i.$el) ||
                (i.toggle && jt(n, i.toggle.$el)) ||
                i.hide(!1);
            });
            Rt(this.$el, "hide", t, { self: !0 });
          },
        },
        {
          name: "beforehide",
          ...
          handler: function (t) {
            ...
            this.$el === e
              ? ((oi = this.isActive() ? null : oi),
                Yt(this.$el, "updatearia"),
                this.tracker.cancel())
              : (oi =
                  null === oi && jt(e, this.$el) && this.isToggled()
                    ? this
                    : oi);
          },
        },
        {
          ...
          handler: function (t, e) {
            t.preventDefault(),
              ...
              (e || this.toggle) &&
                (nt((e || this.toggle).$el, "aria-expanded", this.isToggled()),
              ...
              return (
                (n[i] = t.map(function (t, e) {
                  return 0 === i
                    ? 0
                    : F(n[i - 1][e]) +
                        (o - F(r[i - 1][e] && r[i - 1][e].offsetHeight));
                })),
      ...
      },
      {
        read: function (t) {
          ...
          return {
            scrolled:
              !!this.parallax &&
              pn(this.$el, e ? e - on(this.$el) : 0) * this.parallax,
          };
        },
        write: function (t) {
          var e = t.rows,
            ...
            },
            {
              write: function () {
                ...
                this.elements.forEach(function (t) {
                  ...
                  e &&
                    (n.forceHeight ||
                      Math.round(e + hn("height", t, "content-box")) >=
                        t.offsetHeight) &&
                    He(t, "height", e);
                });
              },
  ...
  function yi(t) {
    ...
    return (
      o &&
        s &&
        (He(t, "minHeight", ""), (e = xi(t)), (i = e.heights), (r = e.max)),
      {
        heights: (i = t.map(function (t, e) {
          return i[e] === r && F(t.style.minHeight).toFixed(2) !== r.toFixed(2)
            ? ""
            : r;
        })),
        elements: t,
    ...
    update: {
      read: function (t) {
        ...
        if (this.expand) {
          if (
            ...
            return !1;
          n =
            on(window) - ($i(document.documentElement) - $i(this.$el)) - i ||
            "";
        } else {
          ...
          !0 === this.offsetBottom
            ...
            : O(this.offsetBottom) &&
              (n += " - " + $i(vt(this.offsetBottom, this.$el)) + "px"),
            (n += (i ? " - " + i + "px" : "") + ")");
        }
      ...
      write: function (t) {
        ...
        He(this.$el, { minHeight: e }),
          ...
          this.minHeight &&
            F(He(this.$el, "minHeight")) < this.minHeight &&
  ...
  var Ii = {
      ...
      disconnected: function () {
        var e = this;
        Bt(this.$el) && nt(this.$el, "hidden", null),
          this.svg &&
      ...
      methods: {
        ...
        applyAttributes: function (n) {
          ...
          for (var t in this.$options.props)
            this[t] && b(this.include, t) && nt(n, t, this[t]);
  ...
  var _i = {},
    ...
    zi = {
      ...
      computed: {
        icon: function (t, e) {
          var n = t.icon;
          return Me(e, "uk-search-icon") && Mt(e, ".uk-search-large").length
            ? "search-large"
            : Mt(e, ".uk-search-navbar").length
            ? "search-navbar"
            : n;
        },
      },
    ...
    Pi = {
      ...
      connected: function () {
        ...
        this.svg.then(function (t) {
          return (
            1 !== e.ratio && He(Se("circle", t), "strokeWidth", 1 / e.ratio)
          );
        }, Z);
      },
    };
        ...
        : this.isImg &&
          ...
          Li(
            ...
            (function (t, e, n) {
              var i;
              n &&
                ((i = et.ratio({ width: t, height: e }, "width", vn(ji(n)))),
                (t = i.width),
                (e = i.height));
              return (
      ...
      load: function (t) {
        ...
        t.some(function (t) {
          ...
          ((this._data.image = ae(
            ...
            return (
              Li(e.$el, qi(t), t.srcset, t.sizes), (Ui[e.cacheKey] = qi(t)), t
            );
          }, Z)),
          this.observer.disconnect());
      },
  ...
  function Li(t, e, n, i) {
    if (Yi(t)) i && (t.sizes = i), n && (t.srcset = n), e && (t.src = e);
      ...
      !b(t.style.backgroundImage, e) &&
        (He(t, "backgroundImage", "url(" + Dt(e) + ")"), Yt(t, qt("load", !1)));
    }
  }
            ...
            Me(document.documentElement, this.clsPage) ||
              ...
              this.bgClose &&
                Rt(
                  this.$el,
                  "hide",
                  ui(document, "click", function (t) {
                    var e = t.defaultPrevented,
                      n = t.target;
                    e ||
                      Gi !== i ||
                      (Gi.overlay && !jt(n, Gi.$el)) ||
                      jt(n, Gi.panel) ||
                      Gi.hide();
                  }),
                  { self: !0 }
              ...
              this.escClose &&
                Rt(
                  this.$el,
                  "hide",
                  Wt(document, "keydown", function (t) {
                    27 === t.keyCode &&
                      Gi === i &&
                      (t.preventDefault(), Gi.hide());
                  }),
                  { self: !0 }
                );
          },
      ...
      return new ee(function (n, i) {
        return Rt(r, "show hide", function () {
          ...
          var t = Rt(
              ...
              "transitionstart",
              function () {
                Rt(s, "transitionend transitioncancel", n, { self: !0 }),
                  clearTimeout(e);
              },
              { self: !0 }
            ),
    ...
    install: function (a) {
      (a.modal.dialog = function (t, e) {
        ...
        (a.modal.alert = function (e, n) {
          return (
            (n = U({ bgClose: !1, escClose: !1, labels: a.modal.labels }, n)),
            new ee(function (t) {
              return Wt(
                a.modal.dialog(
  ...
  var sr = {
      ...
      update: {
        read: function () {
          return (
            !(!this.content || !this.container) && {
              ...
              max: Math.max(
                150,
                on(this.container) - (en(this.content).height - on(this.$el))
              ),
            }
          );
        },
        write: function (t) {
          ...
          He(this.$el, "maxHeight", n),
            Math.round(e) !== Math.round(n) && Yt(this.$el, "resize");
        },
        events: ["resize"],
      },
    },
    ar = {
      ...
      update: {
        read: function () {
          return (
            !!(Pt(this.$el) && this.width && this.height) && {
    ...
    hr = {
      ...
      methods: {
        scrollTo: function (e) {
          ...
          if (
            (t < r + i && (r = t - i), Yt(this.$el, "beforescroll", [this, e]))
          ) {
            var o = Date.now(),
      ...
      events: {
        click: function (t) {
          t.defaultPrevented ||
            (t.preventDefault(),
            this.scrollTo(Dt(decodeURIComponent(this.$el.hash)).substr(1)));
        },
      },
    };
  var cr = {
      ...
      update: [
        {
          write: function () {
            this.hidden &&
              He(
                Ft(this.elements, ":not(." + this.inViewClass + ")"),
                "visibility",
                "hidden"
              );
          },
          ...
          read: function (t) {
            ...
            t.update &&
              this.elements.forEach(function (t) {
                ...
                ((e = e || { cls: ot(t, "uk-scrollspy-class") || n.cls }).show =
                  fn(t, n.offsetTop, n.offsetLeft)),
          ...
          write: function (r) {
            ...
            this.elements.forEach(function (t) {
              ...
              if (!n.show || n.inview || n.queued) {
                ...
                o.delay
                  ? ((n.queued = !0),
                    (r.promise = (r.promise || ee.resolve()).then(function () {
                      return (
                        !n.inview &&
                        new ee(function (t) {
                          var e = setTimeout(
          ...
          write: function (t) {
            ...
            this.links.forEach(function (t) {
              ...
              e &&
                Yt(this.$el, "active", [
                  e,
                  Ce(this.closest ? Nt(e, this.closest) : e, this.cls),
                ]);
          },
          events: ["scroll", "resize"],
        },
                ...
                xn.read(function () {
                  ...
                  i.isFixed &&
                    ...
                    mn(
                      ...
                      t -
                        n -
                        (z(i.targetOffset) ? i.targetOffset : 0) -
                        i.offset
                    );
                });
            }
      ...
      update: [
        {
          read: function (t, e) {
            ...
            return (
              (this.top =
                Math.max(F(dr("top", this)), this.topOffset) - this.offset),
              (this.bottom = i && i - n),
          ...
          write: function (t) {
            var e = t.height,
              ...
              i = this.placeholder;
            He(i, U({ height: e }, n)),
              jt(i, document) || (me(this.$el, i), nt(i, "hidden", "")),
        ...
        },
        {
          read: function (t) {
            ...
            return (
              void 0 === e && (e = 0),
              (this.width = (
                Pt(this.widthElement) ? this.widthElement : this.$el
              ).offsetWidth),
  ...
  function dr(t, e) {
    var n = e.$props,
      ...
      o = n[t];
    if (o)
      return z(o) && O(o) && o.match(/^-?\d/)
        ? r + vn(o)
        : en(!0 === o ? i.parentNode : vt(o, i)).bottom;
  }
  var fr,
    pr = {
      mixins: [ei],
      ...
      update: function () {
        ...
        this.show(Ft(t, "." + this.cls)[0] || t[this.active] || t[0]),
      ...
      methods: {
        index: function () {
          return (
            !B(this.connects) &&
            ce(Ft(this.connects[0].children, "." + this.cls)[0])
          );
        },
        show: function (t) {
          for (
            ...
            if (
              !At(this.toggles[c], ".uk-disabled *, .uk-disabled, [disabled]")
            ) {
  ...
  (Hn.version = "3.1.9"),
    (fr = Hn).component("accordion", ni),
    fr.component("alert", ii),
    fr.component("cover", ai),
    fr.component("drop", ci),
    fr.component("dropdown", li),
    fr.component("formCustom", di),
    fr.component("gif", fi),
    fr.component("grid", vi),
    fr.component("heightMatch", bi),
    fr.component("heightViewport", ki),
    fr.component("icon", Mi),
    fr.component("img", Hi),
    fr.component("leader", Ji),
    fr.component("margin", pi),
    fr.component("modal", er),
    fr.component("nav", nr),
    fr.component("navbar", ir),
    fr.component("offcanvas", rr),
    fr.component("overflowAuto", sr),
    fr.component("responsive", ar),
    fr.component("scroll", hr),
    fr.component("scrollspy", cr),
    fr.component("scrollspyNav", ur),
    fr.component("sticky", lr),
    fr.component("svg", Ii),
    fr.component("switcher", pr),
    fr.component("tab", mr),
    fr.component("toggle", gr),
    fr.component("video", si),
    fr.component("close", Bi),
    fr.component("marker", Oi),
    fr.component("navbarToggleIcon", Oi),
    fr.component("overlayIcon", Oi),
    fr.component("paginationNext", Oi),
    fr.component("paginationPrevious", Oi),
    fr.component("searchIcon", zi),
    fr.component("slidenavNext", Di),
    fr.component("slidenavPrevious", Di),
    fr.component("spinner", Pi),
    fr.component("totop", Oi),
    fr.use(ri);
  var vr = {
    mixins: [ti],
    ...
    yr = {
      ...
      methods: {
        animate: function (t) {
          ...
          !(function () {
            if (wr) return;
            (wr = fe(document.head, "<style>").sheet).insertRule(
              "." +
                br +
            ...
            ee
              .all(
                r
                  ...
                  .concat(
                    Ue.start(this.target, { height: s }, this.animation, "ease")
                  )
              )
              .then(function () {
                r.forEach(function (t, e) {
  ...
  function $r(t) {
    var e = t.getBoundingClientRect(),
      ...
      o = r.top,
      s = r.left;
    return { top: (o += F(He(t, "marginTop"))), left: s, height: n, width: i };
  }
  var Ir = {
    mixins: [yr],
    args: "target",
    ...
    methods: {
      ...
      setState: function (o, t) {
        ...
        void 0 === t && (t = !0),
          (o = U({ filter: { "": "" }, sort: [] }, o)),
          Yt(this.$el, "beforeFilter", [this, o]);
        var a = this.children;
        this.toggles.forEach(function (t) {
          return Oe(
            t,
          ...
          if (n) {
            var r = (function (t, n, i) {
              return U([], t).sort(function (t, e) {
                return (
                  ot(t, n).localeCompare(ot(e, n), void 0, { numeric: !0 }) *
                  ("asc" === i || -1)
                );
              });
            })(a, n, i);
  ...
  var Er = {
    slide: {
      show: function (t) {
        return [{ transform: Ar(-100 * t) }, { transform: Ar() }];
      },
      percent: function (t) {
        return Cr(t);
      },
  ...
  function Ar(t, e) {
    return (
      ...
      void 0 === e && (e = "%"),
      (t += t ? e : ""),
      st ? "translateX(" + t + ")" : "translate3d(" + t + ", 0, 0)"
    );
  }
  function _r(t) {
  ...
  var Nr = U({}, Er, {
    ...
    scale: {
      show: function () {
        return [
          { opacity: 0, transform: _r(0.8) },
          { opacity: 1, transform: _r(1) },
        ];
      },
      percent: function (t) {
        return 1 - He(t, "opacity");
      ...
      translate: function (t) {
        return [
          { opacity: 1 - t, transform: _r(1 - 0.2 * t) },
          { opacity: t, transform: _r(0.8 + 0.2 * t) },
        ];
      },
    },
  });
      ...
      },
      {
        ...
        methods: {
          start: function () {
            ...
            var e =
              "touchmove" != dt
                ? Wt(document, dt, this.move, { passive: !1 })
                : Z;
            (this.unbindMove = function () {
              e(), (t.unbindMove = null);
            }),
              Wt(window, "scroll", this.unbindMove),
              Wt(document, ft, this.end, !0),
              ...
              if (
                ...
                [this.index, this.prevIndex]
                  ...
                  ((this.index === r && this.prevIndex !== r) || h) &&
                    Yt(i[this.index], "itemshown", [this]),
                  l &&
                    ((this.prevIndex = r),
                    (this.index = s),
                    d || Yt(c, "beforeitemhide", [this]),
                    Yt(u, "beforeitemshow", [this])),
                  ...
                  l &&
                    (d || Yt(c, "itemhide", [this]), Yt(u, "itemshow", [this]));
              }
            }
          },
          end: function () {
            if (
              (Vt(window, "scroll", this.unbindMove),
              this.unbindMove && this.unbindMove(),
              Vt(document, ft, this.end, !0),
              this.dragging)
            )
    ...
    methods: {
          ...
          if ((i[e ? "unshift" : "push"](t), !e && 1 < i.length))
            ...
            if (a !== c) {
              if (
                ...
                (this.prevIndex = s),
                (this.index = h),
                a && Yt(a, "beforeitemhide", [this]),
                !Yt(c, "beforeitemshow", [this, a]))
              )
              ...
              return (
                a && Yt(a, "itemhide", [this]), Yt(c, "itemshow", [this]), u
              );
            }
            o();
          }
      ...
      getIndex: function (t, e) {
        return (
          ...
          J(ue(t, this.slides, e, this.finite), 0, this.maxIndex)
        );
      },
      ...
      _show: function (t, e, n) {
        if (
          ...
          return this._transitioner.translate(1), ee.resolve();
  ...
  var zr = {
          ...
          return {
            ...
            show: function (t, e, n) {
              ...
              return (
                ...
                this.translate(e),
                Mr(s, "itemin", { percent: e, duration: t, timing: r, dir: a }),
                Mr(o, "itemout", {
                  percent: 1 - e,
                  duration: t,
                  timing: r,
                ...
                ee
                  .all([Ue.start(s, c[1], t, r), Ue.start(o, c[0], t, r)])
                  .then(function () {
                    i.reset(), u.resolve();
                  }, Z),
                u.promise
            ...
            translate: function (t) {
              ...
              He(s, e[1]),
                He(o, e[0]),
                Mr(s, "itemtranslatein", { percent: t, dir: a }),
    ...
    Br = {
      ...
      events: [
        { name: dt + " " + lt + " keydown", handler: "showControls" },
        {
          name: "click",
          self: !0,
          delegate: function () {
          ...
          handler: function (t, r) {
            ...
            if ((this.setItem(r, "<span uk-spinner></span>"), e))
              if (
                ...
                nt(a, "src", e),
                  Rt(a, "error loadedmetadata", function (t) {
                    "error" === t
                      ? s.setError(r)
                      : (nt(a, { width: a.videoWidth, height: a.videoHeight }),
                        s.setItem(r, a));
                  });
                ...
                ae(
                  ...
                  var e = t.width,
                    n = t.height;
                  120 === e && 90 === n
                    ? ae("https://img.youtube.com/vi/" + h + "/0.jpg").then(
                        function (t) {
                          var e = t.width,
                            n = t.height;
                          return c(e, n);
                ...
                (o = e.match(/(\/\/.*?)vimeo\.[a-z]+\/([0-9]+).*?/)) &&
                  se(
                    "https://vimeo.comhttps://demo.webriefly.com/api/oembed.json?maxwidth=1920&url=" +
                      encodeURI(e),
      ...
      methods: {
        close: function (t) {
          function e() {
            Yt(n.$el, "close", [n]),
              ve(n.$el),
              jr[n.pos].children.length || He(jr[n.pos], "display", "none");
          }
          var n = this;
          this.timer && clearTimeout(this.timer),
      ...
      computed: {
        props: function (m, g) {
          ...
          return Vr.reduce(function (t, e) {
            ...
            s && He(g, e, ""),
              a.length < 2 &&
                a.unshift(("scale" === e ? 1 : s ? He(g, e) : 0) || 0);
            var h = (function (t) {
              return t.reduce(function (t, e) {
          ...
          return {
            ...
            translate: function (t) {
              ...
              He(
                a,
                "transform",
                Ar(J(e - e * t - c, -Gr(a), Zr(a).width) * (at ? -1 : 1), "px")
              ),
                this.updateTranslates(),
                r &&
                  ((t = J(t, -1, 1)),
                  Qr(this.getItemIn(), "itemtranslatein", {
                    percent: t,
                    dir: o,
                  }),
            ...
            percent: function () {
              return Math.abs(
                (He(a, "transform").split(",")[4] * (at ? -1 : 1) + n) / (c - n)
              );
            },
            getDistance: function () {
              return Math.abs(c - n);
      ...
      computed: {
        ...
        maxIndex: function () {
          ...
          for (var t = Kr(this.list), e = this.length; e--; )
            if (Jr(this.list.children[e], this.list) < t)
          ...
          Te(
            ...
            n.maxIndex &&
              Oe(
                t,
                "uk-hidden",
                z(e) && ((n.sets && !b(n.sets, F(e))) || e > n.maxIndex)
              );
          }),
            this.dragging ||
              this.stack.length ||
      ...
      events: {
        beforeitemshow: function (t) {
          ...
          if (!this.dragging && 1 < e) {
            ...
            (this.duration =
              Dr(this.avgWidth / this.velocity) *
              (Zr(
        ...
        },
        {
          ...
          handler: function (t) {
            var e = t.type,
              ...
              s = n.dir;
            Ue.cancel(this.$el),
              He(this.$el, this.getCss(ro(e, s, i))),
              Ue.start(
                this.$el,
                this.getCss(io(e) ? 0.5 : 0 < s ? 1 : 0),
                r,
                o
              ).catch(Z);
          },
  ...
  var oo,
    so = U({}, Er, {
      ...
      scale: {
        show: function () {
          return [
            { opacity: 0, transform: _r(1.5), zIndex: 0 },
            { zIndex: -1 },
          ];
        },
        percent: function (t) {
        ...
        translate: function (t) {
          return [
            { opacity: 1 - t, transform: _r(1 + 0.5 * t), zIndex: 0 },
            { zIndex: -1 },
          ];
        },
      },
      pull: {
        show: function (t) {
          return t < 0
            ? [
                { transform: Ar(30), zIndex: -1 },
                { transform: Ar(), zIndex: 0 },
              ]
            : [
                { transform: Ar(-100), zIndex: 0 },
                { transform: Ar(), zIndex: -1 },
              ];
        },
        ...
        translate: function (t, e) {
          return e < 0
            ? [
                { transform: Ar(30 * t), zIndex: -1 },
                { transform: Ar(-100 * (1 - t)), zIndex: 0 },
              ]
            : [
                { transform: Ar(100 * -t), zIndex: 0 },
                { transform: Ar(30 * (1 - t)), zIndex: -1 },
              ];
        },
      },
      push: {
    ...
    ho = {
      ...
      events: { name: lt, passive: !1, handler: "init" },
      update: {
        write: function () {
          if (
            (this.clsEmpty && Oe(this.$el, this.clsEmpty, B(this.$el.children)),
      ...
      methods: {
        init: function (t) {
          ...
          !r ||
            ...
            Lt(e) ||
            jt(e, "." + this.clsNoDrag) ||
            (this.handle && !jt(e, this.handle)) ||
            (t.preventDefault(),
            (this.touched = [this]),
            (this.placeholder = r),
            (this.origin = U({ target: e, index: ce(r) }, this.pos)),
            Wt(document, dt, this.move),
            Wt(document, ft, this.end),
        ...
        move: function (t) {
          ...
          if (
            (Vt(document, dt, this.move),
            Vt(document, ft, this.end),
            Vt(window, "scroll", this.scroll),
            this.drag)
          ) {
            clearTimeout(oo);
            ...
            this === e
              ? this.origin.index !== ce(this.placeholder) &&
                Yt(this.$el, "moved", [this, this.placeholder])
              : (Yt(e.$el, "added", [e, this.placeholder]),
                Yt(this.$el, "removed", [this, this.placeholder])),
              Yt(this.$el, "stop", [this, this.placeholder]),
              ve(this.drag),
              (this.drag = null);
            var n = this.touched
              .map(function (t) {
    ...
    vo = {
      ...
      beforeConnect: function () {
        (this._hasTitle = it(this.$el, "title")),
          nt(this.$el, { title: "", "aria-expanded": !1 });
      },
      disconnected: function () {
        this.hide(),
          nt(this.$el, {
      ...
      methods: {
        show: function () {
          ...
          !this.isActive() &&
            ...
            go.push(this),
            (this._unbind = Wt(document, ft, function (t) {
        ...
        upload: function (t) {
          ...
          if (t.length) {
            ...
            for (var e = 0; e < t.length; e++) {
              ...
              if (this.allow && !bo(this.allow, t[e].name))
                return void this.fail(
                  this.msgInvalidName.replace("%s", this.allow)
                );
              if (this.mime && !bo(this.mime, t[e].type))
                return void this.fail(
              ...
              o = function (t) {
                ...
                se(i.url, {
                  ...
                  beforeSend: function (t) {
                    var e = t.xhr;
                    e.upload && Wt(e.upload, "progress", i.progress),
  ...
  return (
    Hn.component("countdown", vr),
    Hn.component("filter", Ir),
    Hn.component("lightbox", Lr),
    Hn.component("lightboxPanel", Br),
    Hn.component("notification", Wr),
    Hn.component("parallax", qr),
    Hn.component("slider", eo),
    Hn.component("sliderParallax", no),
    Hn.component("slideshow", ao),
    Hn.component("slideshowParallax", no),
    Hn.component("sortable", ho),
    Hn.component("tooltip", vo),
    Hn.component("upload", wo),
    (po = (fo = Hn).connect),
    (mo = fo.disconnect),
